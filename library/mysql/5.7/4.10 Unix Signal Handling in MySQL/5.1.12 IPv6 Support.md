...
- Your system must be configured to support IPv6. See [Section 5.1.12.1, "Verifying System Support](#page-108-0) [for IPv6".](#page-108-0)
- The default MySQL server configuration permits IPv6 connections in addition to IPv4 connections. To change the default configuration, start the server with the bind\_address system variable set to an appropriate value. See Section 5.1.7, "Server System Variables".
...
## <span id="page-108-0"></span>**5.1.12.1 Verifying System Support for IPv6**
