...
# <span id="page-129-0"></span>**25.19 Using the Performance Schema to Diagnose Problems**
...
At each iteration, the Performance Schema output, particularly the [events\\_waits\\_history\\_long](#page-26-0) table, contains less and less "noise" caused by nonsignificant instruments, and given that this table has a fixed size, contains more and more data relevant to the analysis of the problem at hand.
