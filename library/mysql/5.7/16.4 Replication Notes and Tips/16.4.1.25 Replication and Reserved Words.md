...
For listings of reserved words by MySQL version, see [Keywords and Reserved Words in MySQL 5.7](https://dev.mysql.com/doc/mysqld-version-reference/en/keywords-5-7.md), in the MySQL Server Version Reference. For identifier quoting rules, see Section 9.2, "Schema Object Names".