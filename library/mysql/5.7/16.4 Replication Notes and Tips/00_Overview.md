...
## <span id="page-156-1"></span>**16.4.1 Replication Features and Issues**
...
## <span id="page-156-0"></span>**16.4.1.1 Replication and AUTO\_INCREMENT**

Statement-based replication of AUTO\_INCREMENT, LAST\_INSERT\_ID(), and TIMESTAMP values is done correctly, subject to the following exceptions:

- When using statement-based replication prior to MySQL 5.7.1, AUTO\_INCREMENT columns in tables on the replica must match the same columns on the source; that is, AUTO\_INCREMENT columns must be replicated to AUTO\_INCREMENT columns.
