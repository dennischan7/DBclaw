...
title: 16.4.1.2 Replication and BLACKHOLE Tables
---
...
For this reason we recommend when you replicate to tables using the BLACKHOLE storage engine that you have the [binlog\\_format](#page-83-0) server variable set to STATEMENT, and not to either ROW or MIXED.