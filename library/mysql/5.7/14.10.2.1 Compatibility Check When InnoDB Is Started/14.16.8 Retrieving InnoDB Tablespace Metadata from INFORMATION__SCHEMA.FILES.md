...
title: 14.16.8 Retrieving InnoDB Tablespace Metadata from INFORMATION__SCHEMA.FILES
---
...
The INNODB\_SYS\_TABLESPACES and INNODB\_SYS\_DATAFILES tables also provide metadata about InnoDB tablespaces, but data is limited to file-per-table and general tablespaces.
...
This query retrieves the FILE\_ID and FILE\_NAME for InnoDB temporary tablespaces. Temporary tablespace file names are prefixed by ibtmp.
...
Similarly, InnoDB undo tablespace file names are prefixed by undo. The following query returns the FILE\_ID and FILE\_NAME for InnoDB undo tablespaces, if separate undo tablespaces are configured.
