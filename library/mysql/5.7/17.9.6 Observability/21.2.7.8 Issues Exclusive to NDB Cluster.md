...
title: 21.2.7.8 Issues Exclusive to NDB Cluster
---

The following are limitations specific to the [NDB](#page-96-0) storage engine:
...
See also [Section 21.2.7.10, "Limitations Relating to Multiple NDB Cluster Nodes"](#page-142-0).