...
title: 19.2.1.2 Installing MySQL Shell on Linux
---
...
- If you do not yet have the [MySQL APT repository](https://dev.mysql.com/downloads/repo/apt/) as a software repository on your system, do the following:
  - Follow the steps given in [Adding the MySQL APT Repository](https://dev.mysql.com/doc/mysql-apt-repo-quick-guide/en/#apt-repo-setup), paying special attention to the following:
...
Then, follow the steps given in [Adding the MySQL Yum Repository](https://dev.mysql.com/doc/mysql-yum-repo-quick-guide/en/#repo-qg-yum-repo-setup) to install the new release package, mysql57-community-release.

- If you do not yet have the [MySQL Yum repository](https://dev.mysql.com/downloads/repo/yum/) as a software repository on your system, follow the steps given in [Adding the MySQL Yum Repository](https://dev.mysql.com/doc/mysql-yum-repo-quick-guide/en/#repo-qg-yum-repo-setup).
