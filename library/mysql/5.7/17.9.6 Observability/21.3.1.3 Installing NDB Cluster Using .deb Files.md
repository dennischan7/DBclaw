...
title: 21.3.1.3 Installing NDB Cluster Using .deb Files
---
...
Here, ndbver is the 3-part NDB engine version number, debianver is the major version of Debian (8 or 9), and arch is one of i686 or x86\_64. In the examples that follow, we assume you wish to install NDB 7.6.35 on a 64-bit Debian 9 system; in this case, the installer file is named mysql-clustergpl-7.6.35-debian9-x86\_64.deb-bundle.tar.
