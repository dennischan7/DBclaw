...
## <span id="page-45-2"></span>**8.4.2.1 Optimizing for Numeric Data**
...
### <span id="page-45-3"></span>**8.4.2.2 Optimizing for Character and String Types**
...
- See [Section 8.4.2.1, "Optimizing for Numeric Data"](#page-45-2) for reasons why a numeric column is usually preferable to an equivalent string column.