...
title: 5.4.2.5 Error Log Output Format
---
...
The log\_timestamps system variable controls the time zone of timestamps in messages written to the error log (as well as to general query log and slow query log files).
