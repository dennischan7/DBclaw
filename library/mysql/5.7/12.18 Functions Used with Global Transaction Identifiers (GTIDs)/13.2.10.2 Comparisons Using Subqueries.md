...
title: 13.2.10.2 Comparisons Using Subqueries
---
...
For a comparison of the subquery to a scalar, the subquery must return a scalar. For a comparison of the subquery to a row constructor, the subquery must be a row subquery that returns a row with the same number of values as the row constructor. See [Section 13.2.10.5, "Row Subqueries".](#page-199-0)