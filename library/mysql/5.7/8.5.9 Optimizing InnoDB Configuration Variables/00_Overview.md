...
- Turning the adaptive hash indexing feature on and off using the innodb\_adaptive\_hash\_index option. See Section 14.5.3, "Adaptive Hash Index" for more information. You might change this setting during periods of unusual activity, then restore it to its original setting.
