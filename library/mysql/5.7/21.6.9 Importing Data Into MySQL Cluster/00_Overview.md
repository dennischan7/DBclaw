...
- A CSV file produced by mysqldump or other export program. Such files can be imported into NDB using LOAD DATA INFILE in the mysql client, or with the [ndb\\_import](#page-45-4) utility provided with the NDB Cluster distribution. For more information about the latter, see [Section 21.5.14, "ndb\\_import —](#page-45-4) [Import CSV Data Into NDB"](#page-45-4).
- A native NDB backup produced using [START BACKUP](#page-192-0) in the NDB management client. To import a native backup, you must use the [ndb\\_restore](#page-81-3) program that comes as part of NDB Cluster. See [Section 21.5.24, "ndb\\_restore — Restore an NDB Cluster Backup",](#page-81-3) for more about using this program.
