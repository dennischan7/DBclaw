...
To tune queries for InnoDB tables, create an appropriate set of indexes on each table. See [Section 8.3.1, "How MySQL Uses Indexes"](#page-30-0) for details. Follow these guidelines for InnoDB indexes:
...
- You can optimize single-query transactions for InnoDB tables, using the technique in [Section 8.5.3,](#page-56-0) ["Optimizing InnoDB Read-Only Transactions".](#page-56-0)