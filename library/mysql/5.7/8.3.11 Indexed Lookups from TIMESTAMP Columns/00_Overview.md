...
The same lack of one-to-one mapping for time zone conversions in both directions occurs in other contexts as well, such as conversions performed with the FROM\_UNIXTIME() and UNIX\_TIMESTAMP() functions. See Section 12.7, "Date and Time Functions".