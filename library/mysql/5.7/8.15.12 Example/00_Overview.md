...
As just shown in the second portion of the range analysis, it is not possible to use GROUP\_MIN\_MAX because it accepts only one table, and we have two in the join. This means that no range access is possible.
