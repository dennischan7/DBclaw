...
title: 5.7.3 Running Multiple MySQL Instances on Unix
---
...
On Unix, the mysqld\_multi script provides another way to start multiple servers. See Section 4.3.4, "mysqld\_multi — Manage Multiple MySQL Servers".