...
title: 5.7.4 Using Client Programs in a Multiple-Server Environment
---
...
- On Unix, set the MYSQL\_UNIX\_PORT and MYSQL\_TCP\_PORT environment variables to point to the Unix socket file and TCP/IP port number before you start your clients. If you normally use a specific socket file or port number, you can place commands to set these environment variables in your .login file so that they apply each time you log in. See Section 4.9, "Environment Variables".
...
- In a C program, you can specify the socket file or port number arguments in the [mysql\\_real\\_connect\(\)](https://dev.mysql.com/doc/c-api/5.7/en/mysql-real-connect.md) call. You can also have the program read option files by calling [mysql\\_options\(\)](https://dev.mysql.com/doc/c-api/5.7/en/mysql-options.md). See [C API Basic Function Descriptions](https://dev.mysql.com/doc/c-api/5.7/en/c-api-function-descriptions.md).
...
# <span id="page-196-0"></span>**5.8 Debugging MySQL**
