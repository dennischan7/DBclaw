...
title: 5.7.2.1 Starting Multiple MySQL Instances at the Windows Command Line
---
...
A similar procedure applies for servers that you want to permit shared-memory connections. Enable such connections by starting the server with the [shared\\_memory](#page-19-0) system variable enabled and specify a unique shared-memory name for each server by setting the [shared\\_memory\\_base\\_name](#page-19-1) system variable.