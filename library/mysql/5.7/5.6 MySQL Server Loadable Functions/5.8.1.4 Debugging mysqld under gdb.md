...
title: 5.8.1.4 Debugging mysqld under gdb
---
...
It is very hard to debug MySQL under gdb if you do a lot of new connections the whole time as gdb does not free the memory for old threads. You can avoid this problem by starting mysqld with [thread\\_cache\\_size](#page-37-1) set to a value equal to max\_connections + 1. In most cases just using [-](#page-37-1) [thread\\_cache\\_size=5'](#page-37-1) helps a lot!
