...
title: 5.8.1.6 Using Server Logs to Find Causes of Errors in mysqld
---
...
If you find the text mysqld restarted in the error log (normally a file named host\_name.err) you probably have found a query that causes mysqld to fail. If this happens, you should check all your tables with myisamchk (see Chapter 5, MySQL Server Administration), and test the queries in the MySQL log files to see whether one fails. If you find such a query, try first upgrading to the newest MySQL version. If this does not help, report a bug, see Section 1.5, "How to Report Bugs or Problems".
