...
title: 25.2.7.7 Limitations Relating to Performance in NDB Cluster
---

The following performance issues are specific to or especially pronounced in NDB Cluster:

- **Range scans.** There are query performance issues due to sequential access to the [NDB](#page-128-0) storage engine; it is also relatively more expensive to do many range scans than it is with either MyISAM or InnoDB.
