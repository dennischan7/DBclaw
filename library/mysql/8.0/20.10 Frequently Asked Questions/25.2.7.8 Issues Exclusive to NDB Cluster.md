...
title: 25.2.7.8 Issues Exclusive to NDB Cluster
---

The following are limitations specific to the [NDB](#page-128-0) storage engine:
...
See also [Section 25.2.7.10, "Limitations Relating to Multiple NDB Cluster Nodes"](#page-188-0).