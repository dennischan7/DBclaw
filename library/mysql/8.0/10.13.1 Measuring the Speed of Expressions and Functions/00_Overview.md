...
To measure the speed of a specific MySQL expression or function, invoke the BENCHMARK() function using the mysql client program. Its syntax is BENCHMARK(loop\_count,expr). The return value is
...
## <span id="page-19-0"></span>**10.13.2 Using Your Own Benchmarks**
