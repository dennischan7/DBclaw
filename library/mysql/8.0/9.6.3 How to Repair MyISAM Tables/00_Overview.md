...
This section is for the cases where a table check fails (such as those described in [Section 9.6.2, "How](#page-15-0) [to Check MyISAM Tables for Errors"\)](#page-15-0), or you want to use the extended features that myisamchk provides.
