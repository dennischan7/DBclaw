...
For this reason we recommend when you replicate to tables using the BLACKHOLE storage engine that you have the binlog\_format server variable set to STATEMENT, and not to either ROW or MIXED.