...
NDB Cluster supports storing nonindexed columns of NDB tables on disk, rather than in RAM. Column data and logging metadata are kept in data files and undo log files, conceptualized as tablespaces and log file groups, as described in the next section—see [Section 25.6.11.1, "NDB Cluster Disk Data](#page-101-0) [Objects"](#page-101-0).
...
- [Section 25.6.16.31, "The ndbinfo diskstat Table"](#page-161-0)
- [Section 25.6.16.32, "The ndbinfo diskstats\\_1sec Table"](#page-162-0)
- [Section 25.6.16.49, "The ndbinfo pgman\\_time\\_track\\_stats Table"](#page-192-0)

# <span id="page-101-0"></span>**25.6.11.1 NDB Cluster Disk Data Objects**
