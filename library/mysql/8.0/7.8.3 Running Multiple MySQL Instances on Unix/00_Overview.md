...
Assume that an existing 5.7 server is configured for the default TCP/IP port number (3306) and Unix socket file (/tmp/mysql.sock). To configure a new 8.0.45 server to have different operating parameters, use a CMake command something like this:
