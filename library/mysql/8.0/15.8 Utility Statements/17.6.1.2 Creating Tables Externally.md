...
- As of MySQL 8.0.21, tables created in file-per-table tablespaces can no longer be created in the undo tablespace directory (innodb\_undo\_directory) unless that directly is known to InnoDB. Known directories are those defined by the datadir, innodb\_data\_home\_dir, and innodb\_directories variables.
...
- For information about creating a general tablespace in an external directory, see [Creating a General](#page-34-0) [Tablespace.](#page-34-0)
- For information about creating a table in a general tablespace, see [Adding Tables to a General](#page-34-1) [Tablespace.](#page-34-1)

# <span id="page-1-1"></span>**17.6.1.3 Importing InnoDB Tables**
...
- [Limitations](#page-6-0)
- [Usage Notes](#page-6-1)
- [Internals](#page-7-0)
...
### <span id="page-6-0"></span>**Limitations**
...
### <span id="page-6-1"></span>**Usage Notes**
...
#### <span id="page-7-0"></span>**Internals**
...
[Warning] InnoDB: Table "test"."t1" tablespace is set as discarded. 7f34d9a37700 InnoDB: cannot calculate statistics for table "test"."t1" because the .ibd file is missing. For help, please refer to http://dev.mysql.com/doc/refman/8.0/en/innodb-troubleshooting.html

# <span id="page-8-3"></span>**17.6.1.4 Moving or Copying InnoDB Tables**
...
A table that resides in a file-per-table tablespace can be imported from another MySQL server instance or from a backup using the Transportable Tablespace feature. See [Section 17.6.1.3, "Importing InnoDB](#page-1-1) [Tables"](#page-1-1).
