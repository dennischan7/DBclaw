...
You can use the [ndbxfrm](#page-35-0) utility to see whether a file is encrypted, as shown here:
...
Beginning with NDB 8.0.31, it is possible to obtain the key from the secrets file using the [ndb\\_secretsfile\\_reader](#page-2-0) program added in that release, like this:
