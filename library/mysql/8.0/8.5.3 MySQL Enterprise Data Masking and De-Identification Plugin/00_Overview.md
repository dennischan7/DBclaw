...
- A server-side plugin named data\_masking.
...
## <span id="page-156-0"></span>**8.5.3.1 MySQL Enterprise Data Masking and De-Identification Plugin Installation**
...
The plugin library file base name is data\_masking. The file name suffix differs per platform (for example, .so for Unix and Unix-like systems, .dll for Windows).
