...
MySQLReplicationKey\_{UUID}\_{SEQ\_NO}

#### For example:

MySQLReplicationKey\_00508583-b5ce-11e8-a6a5-0010e0734796\_1

{UUID} is the true UUID generated by the MySQL server (the value of the server\_uuid system variable). {SEQ\_NO} is the sequence number for the binary log encryption key, which is incremented by 1 for each new key that is generated on the server.
