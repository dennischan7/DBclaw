...
title: 10.14.3 General Thread States
---
...
For information about table lock indicators, see Section 10.11.1, "Internal Locking Methods". For information about metadata locking, see [Section 10.11.4, "Metadata Locking".](#page-3-1) To see which locks are blocking lock requests, use the Performance Schema lock tables described at Section 29.12.13, "Performance Schema Lock Tables".
