...
title: 10.14.1 Accessing the Process List
---
...
- [Sources of Process Information](#page-20-0)
- [Privileges Required to Access the Process List](#page-21-0)
- [Content of Process List Entries](#page-21-1)

### <span id="page-20-0"></span>**Sources of Process Information**
...
- The Performance Schema threads table columns with names having a prefix of PROCESSLIST\_: Section 29.12.21.8, "The threads Table"
...
### <span id="page-21-0"></span>**Privileges Required to Access the Process List**
...
### <span id="page-21-1"></span>**Content of Process List Entries**
