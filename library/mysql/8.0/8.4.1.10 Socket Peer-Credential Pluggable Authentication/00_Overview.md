...
- [Installing Socket Pluggable Authentication](#page-97-0)
- [Uninstalling Socket Pluggable Authentication](#page-98-0)
- [Using Socket Pluggable Authentication](#page-98-1)

For general information about pluggable authentication in MySQL, see Section 8.2.17, "Pluggable Authentication".

## <span id="page-97-0"></span>**Installing Socket Pluggable Authentication**
...
To associate MySQL accounts with the socket plugin, see [Using Socket Pluggable Authentication.](#page-98-1)

## <span id="page-98-0"></span>**Uninstalling Socket Pluggable Authentication**
...
## <span id="page-98-1"></span>**Using Socket Pluggable Authentication**
