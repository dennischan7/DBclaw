...
[Table 17.12, "ROW\\_FORMAT and KEY\\_BLOCK\\_SIZE Options"](#page-140-0) provides an overview the ROW\_FORMAT and KEY\_BLOCK\_SIZE options that are used with CREATE TABLE or ALTER TABLE.
...
[Table 17.13, "CREATE/ALTER TABLE Warnings and Errors when InnoDB Strict Mode is OFF"](#page-141-0) summarizes error conditions that occur with certain combinations of configuration parameters and options on the CREATE TABLE or ALTER TABLE statements, and how the options appear in the output of SHOW TABLE STATUS.
...
For more information about using compressed tables with general tablespaces, see [Section 17.6.3.3,](#page-33-0) ["General Tablespaces".](#page-33-0)