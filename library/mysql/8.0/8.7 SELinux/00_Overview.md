...
- system\_u is an SELinux user identity for system processes and objects.
- system\_r is an SELinux role used for system processes.
- objects\_r is an SELinux role used for system objects.
- mysqld\_t is the type associated with the mysqld process.
- mysqld\_db\_t is the type associated with the MySQL data directory and its files.
