...
- A native NDB backup produced using [START BACKUP](#page-93-0) in the NDB management client. To import a native backup, you must use the ndb\_restore program that comes as part of NDB Cluster. See Section 25.5.23, "ndb\_restore — Restore an NDB Cluster Backup", for more about using this program.
