...
Performance of Disk Data tables can be improved by minimizing the number of disk seeks by making sure that DiskPageBufferMemory is of sufficient size. You can query the [diskpagebuffer](#page-160-0) table to help determine whether the value for this parameter needs to be increased.