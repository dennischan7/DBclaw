...
The backup\_id table contains a single column id, which corresponds to a backup ID taken using the ndb\_mgm client [START BACKUP](#page-93-0) command. This table contains a single row.
...
The backup\_id table was added in NDB 8.0.24.