...
For listings of reserved words by MySQL version, see [Keywords and Reserved Words in MySQL 8.0](https://dev.mysql.com/doc/mysqld-version-reference/en/keywords-8-0.md), in the MySQL Server Version Reference. For identifier quoting rules, see Section 11.2, "Schema Object Names".