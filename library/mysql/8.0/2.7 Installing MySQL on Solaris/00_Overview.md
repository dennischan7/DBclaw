...
- For information on installing using the native Solaris PKG format, see [Section 2.7.1, "Installing](#page-53-0) [MySQL on Solaris Using a Solaris PKG".](#page-53-0)
...
To obtain a binary MySQL distribution for Solaris in tarball or PKG format, [https://dev.mysql.com/](https://dev.mysql.com/downloads/mysql/8.0.md) [downloads/mysql/8.0.html](https://dev.mysql.com/downloads/mysql/8.0.md).
...
# <span id="page-53-0"></span>**2.7.1 Installing MySQL on Solaris Using a Solaris PKG**
...
You should check the notes in Chapter 3, [Upgrading MySQL](#page-110-0) before performing any upgrade.

# <span id="page-54-0"></span>**2.8 Installing MySQL from Source**
