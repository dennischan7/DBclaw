...
Regarding passwords, if you installed MySQL using the MySQL Installer, you may have already assigned a password to the initial root account. (See Section 2.3.3, "MySQL Installer for Windows".) Otherwise, use the password-assignment procedure given in [Section 2.9.4, "Securing the Initial MySQL](#page-104-0) [Account"](#page-104-0).
