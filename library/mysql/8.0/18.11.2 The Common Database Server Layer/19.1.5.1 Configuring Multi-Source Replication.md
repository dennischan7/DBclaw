...
title: 19.1.5.1 Configuring Multi-Source Replication
---
...
Sources in a multi-source replication topology can be configured to use either GTID-based replication, or binary log position-based replication. See [Section 19.1.3.4, "Setting Up Replication Using GTIDs"](#page-31-0) for how to configure a source using GTID-based replication. See [Section 19.1.2.1, "Setting the Replication](#page-10-0) [Source Configuration"](#page-10-0) for how to configure a source using file position based replication.
...
For more details, and important information on the default authentication plugin for new users from MySQL 8.0, see [Section 19.1.2.3, "Creating a User for Replication".](#page-11-0)