...
title: 8.7.6 Troubleshooting SELinux
---
...
For information about setting the proper SELinux context for MySQL directories and files, see [Section 8.7.4, "SELinux File Context".](#page-189-0)
...
For information about setting the proper SELinux port context for MySQL, see [Section 8.7.5, "SELinux](#page-191-0) [TCP Port Context".](#page-191-0) Similar port access issues can occur when enabling MySQL features that use ports that are not defined with the required context. For more information, see [Section 8.7.5.2, "Setting the](#page-191-1) [TCP Port Context for MySQL Features"](#page-191-1).
