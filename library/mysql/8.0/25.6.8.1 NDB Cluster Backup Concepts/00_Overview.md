...
# <span id="page-93-0"></span>**25.6.8.2 Using The NDB Cluster Management Client to Create a Backup**

Before starting a backup, make sure that the cluster is properly configured for performing one. (See [Section 25.6.8.3, "Configuration for NDB Cluster Backups".](#page-97-0))
...
Starting with NDB 8.0.24, the PASSWORD option can be omitted from encryption\_option. In this case, the management client prompts the user for a password.
...
- [ndbxfrm](#page-35-0) [--decrypt-password=](#page-36-3)password input\_file output\_file
...
- [ndbxfrm](#page-35-0) [--decrypt-password-from-stdin](#page-37-0) input\_file output\_file
- ndb\_print\_backup\_file --backup-password=password file\_name
- ndb\_print\_backup\_file --backup-password-from-stdin file\_name
...
<span id="page-96-0"></span>**Cancelling backups.** To cancel or abort a backup that is already in progress, perform the following steps:
...
# <span id="page-97-0"></span>**25.6.8.3 Configuration for NDB Cluster Backups**
