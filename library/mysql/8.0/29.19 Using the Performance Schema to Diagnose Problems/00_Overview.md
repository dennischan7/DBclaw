...
With each iteration, the Performance Schema output, particularly the events\_waits\_history\_long table, contains less and less "noise" caused by nonsignificant instruments, and given that this table has a fixed size, contains more and more data relevant to the analysis of the problem at hand.
