...
A statement invoking a trigger (or function) that causes an update to an AUTO\_INCREMENT column is not replicated correctly using statement-based replication. MySQL 8.0 marks such statements as unsafe. (Bug #45677)
