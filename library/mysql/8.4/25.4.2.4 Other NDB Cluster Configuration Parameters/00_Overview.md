...
- [HostName](#page-140-1): Host name or IP address of this computer.
- [Id](#page-139-0): Unique identifier for this computer.
...
- TCP\_MAXSEG\_SIZE: Value used for TCP\_MAXSEG.
- TCP\_RCV\_BUF\_SIZE: Value used for SO\_RCVBUF.
- TCP\_SND\_BUF\_SIZE: Value used for SO\_SNDBUF.
- TcpBind\_INADDR\_ANY: Bind InAddrAny instead of host name for server part of connection.
