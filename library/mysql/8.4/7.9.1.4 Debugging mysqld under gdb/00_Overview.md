...
- mysqld crashes during a pthread\_mutex\_lock() or pthread\_mutex\_unlock() call.
...
If you are using the Perl DBI interface, you can turn on debugging information by using the trace method or by setting the DBI\_TRACE environment variable.