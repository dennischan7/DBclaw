...
- [Server-Side Runtime Configuration and Monitoring for SSL Session Reuse](#page-90-0)
- [Client-Side Configuration for SSL Session Reuse](#page-91-0)
...
C applications can use the C API capabilities to enable session reuse for encrypted connections (see [SSL Session Reuse\)](https://dev.mysql.com/doc/c-api/8.4/en/c-api-ssl-session-reuse.md).

# <span id="page-90-0"></span>**Server-Side Runtime Configuration and Monitoring for SSL Session Reuse**
...
# <span id="page-91-0"></span>**Client-Side Configuration for SSL Session Reuse**
