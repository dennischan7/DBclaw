...
# <span id="page-47-0"></span>**20.5.1.4 Setting a Group's Communication Protocol Version**
...
- MySQL 5.7.14 and later allows compression of messages (see [Section 20.7.4, "Message](#page-94-0) [Compression"](#page-94-0)).
- MySQL 8.0.16 and later also allows fragmentation of messages (see [Section 20.7.5, "Message](#page-96-0) [Fragmentation"\)](#page-96-0).
- MySQL 8.0.27 and later also allow the group communication engine to operate with a single consensus leader when the group is in single-primary mode and [group\\_replication\\_paxos\\_single\\_leader](#page-152-0) is set to true (see [Section 20.7.3, "Single](#page-93-0) [Consensus Leader"](#page-93-0)).
