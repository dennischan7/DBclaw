...
## <span id="page-33-1"></span>**8.7.5.2 Setting the TCP Port Context for MySQL Features**
...
For MySQL 8.4, enabling mysql\_connect\_any is not required or recommended.
