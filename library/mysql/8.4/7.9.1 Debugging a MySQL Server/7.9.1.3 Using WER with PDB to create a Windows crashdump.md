...
```
windbg.exe -i "C:\mysql-8.4.8-winx64\bin\"^
 -z "C:\mysql-8.4.8-winx64\data\mysqld.dmp"^
 -srcpath "E:\ade\mysql_archives\8.4\8.4.8\mysql-8.4.8"^
 -y "C:\mysql-8.4.8-winx64\bin;SRV*c:\symbols*http://msdl.microsoft.com/download/symbols"^
 -v -n -c "!analyze -vvvvv"
```
