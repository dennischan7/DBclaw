...
- **Range scans.** There are query performance issues due to sequential access to the [NDB](#page-50-0) storage engine; it is also relatively more expensive to do many range scans than it is with either MyISAM or InnoDB.
