...
- [Cost Model General Operation](#page-24-0)
- [The Cost Model Database](#page-24-1)
- [Making Changes to the Cost Model Database](#page-26-0)

#### <span id="page-24-0"></span>**Cost Model General Operation**
...
### <span id="page-24-1"></span>**The Cost Model Database**
...
#### <span id="page-26-0"></span>**Making Changes to the Cost Model Database**
...
For example, all other things being equal, setting io\_block\_read\_cost to a value larger than memory\_block\_read\_cost causes the optimizer to prefer query plans that read information already held in memory to plans that must read from disk.
