...
| Name                         | Description                                     |
|------------------------------|-------------------------------------------------|
| WAIT_FOR_EXECUTED_GTID_SET() | Wait until the given GTIDs have executed on the |
|                              | replica.                                        |

<span id="page-0-0"></span>• [GTID\\_SUBSET\(](#page-0-0)set1,set2)
...
<span id="page-0-1"></span>• [GTID\\_SUBTRACT\(](#page-0-1)set1,set2)
...
<span id="page-1-0"></span>• [WAIT\\_FOR\\_EXECUTED\\_GTID\\_SET\(](#page-1-0)gtid\_set[, timeout])
