...
### <span id="page-88-0"></span>**Example 3: Creating SSL Files on Windows**
...
After generating the certificate and key files, to use them for SSL connections, see [Section 8.3.1,](#page-67-0) ["Configuring MySQL to Use Encrypted Connections".](#page-67-0)