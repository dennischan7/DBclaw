...
title: 19.3.3.3 Recovering From Failed Replication Privilege Checks
---
...
If GTIDs are not in use, issue a SET GLOBAL sql\_replica\_skip\_counter statement to skip the event. For instructions to use this alternative method and more details about skipping transactions, see [Section 19.1.7.3, "Skipping Transactions".](#page-107-0)