...
title: 25.6.15.61 The ndbinfo tc__time__track__stats Table
---
...
The block\_instance column provides the [DBTC](https://dev.mysql.com/doc/ndb-internals/en/ndb-internals-kernel-blocks-dbtc.md) kernel block instance number. You can use this together with the block name to obtain information about specific threads from the [threadblocks](#page-62-0) table.

## <span id="page-62-0"></span>**25.6.15.62 The ndbinfo threadblocks Table**
