...
# <span id="page-99-0"></span>**14.16.3 Functions That Create Geometry Values from WKT Values**
...
[ST\\_GeomFromText\(\)](#page-100-1) accepts a WKT value of any geometry type as its first argument. Other functions provide type-specific construction functions for construction of geometry values of each geometry type.

Functions such as [ST\\_MPointFromText\(\)](#page-101-1) and [ST\\_GeomFromText\(\)](#page-100-1) that accept WKT-format representations of MultiPoint values permit individual points within values to be surrounded by parentheses. For example, both of the following function calls are valid:
...
- If an SRID argument refers to an undefined spatial reference system (SRS), an [ER\\_SRS\\_NOT\\_FOUND](https://dev.mysql.com/doc/mysql-errors/8.4/en/server-error-reference.md#error_er_srs_not_found) error occurs.
...
<span id="page-100-1"></span>• [ST\\_GeomFromText\(](#page-100-1)wkt [, srid [, options]]), [ST\\_GeometryFromText\(](#page-100-1)wkt [, srid [, [options](#page-100-1)]])

Constructs a geometry value of any type using its WKT representation and SRID.

These functions handle their arguments as described in the introduction to this section.

<span id="page-100-2"></span>• [ST\\_LineFromText\(](#page-100-2)wkt [, srid [, options]]), [ST\\_LineStringFromText\(](#page-100-2)wkt [, srid [, [options](#page-100-2)]])

Constructs a LineString value using its WKT representation and SRID.

These functions handle their arguments as described in the introduction to this section.

<span id="page-101-0"></span>• [ST\\_MLineFromText\(](#page-101-0)wkt [, srid [, options]]), [ST\\_MultiLineStringFromText\(](#page-101-0)wkt [, srid [, [options](#page-101-0)]])

Constructs a MultiLineString value using its WKT representation and SRID.

These functions handle their arguments as described in the introduction to this section.

<span id="page-101-1"></span>• [ST\\_MPointFromText\(](#page-101-1)wkt [, srid [, options]]), [ST\\_MultiPointFromText\(](#page-101-1)wkt [, srid [, [options](#page-101-1)]])

Constructs a MultiPoint value using its WKT representation and SRID.

These functions handle their arguments as described in the introduction to this section.

<span id="page-101-2"></span>• [ST\\_MPolyFromText\(](#page-101-2)wkt [, srid [, options]]), [ST\\_MultiPolygonFromText\(](#page-101-2)wkt [, srid [, [options](#page-101-2)]])

Constructs a MultiPolygon value using its WKT representation and SRID.

These functions handle their arguments as described in the introduction to this section.

<span id="page-101-3"></span>• [ST\\_PointFromText\(](#page-101-3)wkt [, srid [, options]])

Constructs a Point value using its WKT representation and SRID.

[ST\\_PointFromText\(\)](#page-101-3) handles its arguments as described in the introduction to this section.

<span id="page-101-4"></span>• [ST\\_PolyFromText\(](#page-101-4)wkt [, srid [, options]]), [ST\\_PolygonFromText\(](#page-101-4)wkt [, srid [, [options](#page-101-4)]])

Constructs a Polygon value using its WKT representation and SRID.

These functions handle their arguments as described in the introduction to this section.

# <span id="page-101-5"></span>**14.16.4 Functions That Create Geometry Values from WKB Values**
...
[ST\\_GeomFromWKB\(\)](#page-102-1) accepts a WKB value of any geometry type as its first argument. Other functions provide type-specific construction functions for construction of geometry values of each geometry type.

Prior to MySQL 8.4, these functions also accepted geometry objects as returned by the functions in [Section 14.16.5, "MySQL-Specific Functions That Create Geometry Values"](#page-103-6). Geometry arguments are no longer permitted and produce an error. To migrate calls from using geometry arguments to using WKB arguments, follow these guidelines:
...
<span id="page-102-1"></span>• [ST\\_GeomFromWKB\(](#page-102-1)wkb [, srid [, options]]), [ST\\_GeometryFromWKB\(](#page-102-1)wkb [, srid [, [options](#page-102-1)]])

Constructs a geometry value of any type using its WKB representation and SRID.

These functions handle their arguments as described in the introduction to this section.

<span id="page-102-2"></span>• [ST\\_LineFromWKB\(](#page-102-2)wkb [, srid [, options]]), [ST\\_LineStringFromWKB\(](#page-102-2)wkb [, srid [, [options](#page-102-2)]])

Constructs a LineString value using its WKB representation and SRID.

These functions handle their arguments as described in the introduction to this section.

<span id="page-102-3"></span>• [ST\\_MLineFromWKB\(](#page-102-3)wkb [, srid [, options]]), [ST\\_MultiLineStringFromWKB\(](#page-102-3)wkb [, srid [, [options](#page-102-3)]])

Constructs a MultiLineString value using its WKB representation and SRID.

These functions handle their arguments as described in the introduction to this section.

<span id="page-102-4"></span>• [ST\\_MPointFromWKB\(](#page-102-4)wkb [, srid [, options]]), [ST\\_MultiPointFromWKB\(](#page-102-4)wkb [, srid [, [options](#page-102-4)]])

Constructs a MultiPoint value using its WKB representation and SRID.

These functions handle their arguments as described in the introduction to this section.

<span id="page-102-5"></span>• [ST\\_MPolyFromWKB\(](#page-102-5)wkb [, srid [, options]]), [ST\\_MultiPolygonFromWKB\(](#page-102-5)wkb [, srid [, [options](#page-102-5)]])

Constructs a MultiPolygon value using its WKB representation and SRID.

These functions handle their arguments as described in the introduction to this section.

<span id="page-103-4"></span>• [ST\\_PointFromWKB\(](#page-103-4)wkb [, srid [, options]])

Constructs a Point value using its WKB representation and SRID.

[ST\\_PointFromWKB\(\)](#page-103-4) handles its arguments as described in the introduction to this section.

<span id="page-103-5"></span>• [ST\\_PolyFromWKB\(](#page-103-5)wkb [, srid [, options]]), [ST\\_PolygonFromWKB\(](#page-103-5)wkb [, srid [, [options](#page-103-5)]])

Constructs a Polygon value using its WKB representation and SRID.

These functions handle their arguments as described in the introduction to this section.

## <span id="page-103-6"></span>**14.16.5 MySQL-Specific Functions That Create Geometry Values**
...
For example, you can insert the geometry return value from [Point\(\)](#page-104-2) directly into a POINT column:

```
INSERT INTO t1 (pt_col) VALUES(Point(1,2));
```

• [GeomCollection\(](#page-103-0)g [, g] ...)

Constructs a GeomCollection value from the geometry arguments.

[GeomCollection\(\)](#page-103-0) returns all the proper geometries contained in the arguments even if a nonsupported geometry is present.

[GeomCollection\(\)](#page-103-0) with no arguments is permitted as a way to create an empty geometry. Also, functions such as [ST\\_GeomFromText\(\)](#page-100-1) that accept WKT geometry collection arguments understand both OpenGIS 'GEOMETRYCOLLECTION EMPTY' standard syntax and MySQL 'GEOMETRYCOLLECTION()' nonstandard syntax.

[GeomCollection\(\)](#page-103-0) and [GeometryCollection\(\)](#page-103-1) are synonymous, with [GeomCollection\(\)](#page-103-0) the preferred function.

<span id="page-103-1"></span>• [GeometryCollection\(](#page-103-1)g [, g] ...)

Constructs a GeomCollection value from the geometry arguments.

[GeometryCollection\(\)](#page-103-1) returns all the proper geometries contained in the arguments even if a nonsupported geometry is present.

[GeometryCollection\(\)](#page-103-1) with no arguments is permitted as a way to create an empty geometry. Also, functions such as [ST\\_GeomFromText\(\)](#page-100-1) that accept WKT geometry collection arguments understand both OpenGIS 'GEOMETRYCOLLECTION EMPTY' standard syntax and MySQL 'GEOMETRYCOLLECTION()' nonstandard syntax.

[GeomCollection\(\)](#page-103-0) and [GeometryCollection\(\)](#page-103-1) are synonymous, with [GeomCollection\(\)](#page-103-0) the preferred function.

<span id="page-103-2"></span>• [LineString\(](#page-103-2)pt [, pt] ...)
...
<span id="page-103-3"></span>• [MultiLineString\(](#page-103-3)ls [, ls] ...)

Constructs a MultiLineString value using LineString or WKB LineString arguments.

<span id="page-104-0"></span>• [MultiPoint\(](#page-104-0)pt [, pt2] ...)

Constructs a MultiPoint value using Point or WKB Point arguments.

<span id="page-104-1"></span>• [MultiPolygon\(](#page-104-1)poly [, poly] ...)

Constructs a MultiPolygon value from a set of Polygon or WKB Polygon arguments.

<span id="page-104-2"></span>• [Point\(](#page-104-2)x, y)

Constructs a Point using its coordinates.

<span id="page-104-3"></span>• [Polygon\(](#page-104-3)ls [, ls] ...)
