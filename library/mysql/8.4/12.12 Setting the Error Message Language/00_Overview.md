...
# <span id="page-12-0"></span>**12.13 Adding a Character Set**
...
The <charset> element must list all the collations for the character set. These must include at least a binary collation and a default (primary) collation. The default collation is often named using a suffix of general\_ci (general, case-insensitive). It is possible for the binary collation to be the
...
- The <map> array element for the <ctype> element has 257 words. The other <map> array elements after that have 256 words. See [Section 12.13.1, "Character Definition Arrays"](#page-14-0).
...
- If the character set requires string collating functions, see [Section 12.13.2, "String Collating](#page-15-0) [Support for Complex Character Sets"](#page-15-0).
- If the character set requires multibyte character support, see [Section 12.13.3, "Multi-Byte](#page-15-1) [Character Support for Complex Character Sets"](#page-15-1).
...
- c. Edit cmake/character\_sets.cmake:
  ...
  - ii. Add MYSET to the value of CHARSETS\_COMPLEX in alphabetic order. This is needed even for simple character sets, so that CMake can recognize -DDEFAULT\_CHARSET=MYSET.
- 4. Reconfigure, recompile, and test.

## <span id="page-14-0"></span>**12.13.1 Character Definition Arrays**
...
Each <collation> array indicates how characters should be ordered for comparison and sorting purposes. MySQL sorts characters based on the values of this information. In some cases, this is the same as the <upper> array, which means that sorting is case-insensitive. For more complicated sorting rules (for complex character sets), see the discussion of string collating in [Section 12.13.2,](#page-15-0) ["String Collating Support for Complex Character Sets"](#page-15-0).

## <span id="page-15-0"></span>**12.13.2 String Collating Support for Complex Character Sets**
...
## <span id="page-15-1"></span>**12.13.3 Multi-Byte Character Support for Complex Character Sets**
