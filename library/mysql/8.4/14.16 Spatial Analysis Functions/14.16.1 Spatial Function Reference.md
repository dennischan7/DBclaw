...
title: 14.16.1 Spatial Function Reference
---
...
| MBRContains()             | Whether MBR of one geometry contains MBR of<br>another           |  |
...
| MBRWithin()               | Whether MBR of one geometry is within MBR of<br>another          |  |
...
| ST_Buffer()               | Return geometry of points within given distance<br>from geometry |  |
...
| Name                                                                               | Description                                                     |  |
|------------------------------------------------------------------------------------|-----------------------------------------------------------------|--|
| ST_Distance_Sphere()                                                               | Minimum distance on earth between two<br>geometries             |  |
...
| ST_FrechetDistance()                                                               | The discrete Fréchet distance of one geometry<br>from another   |  |
...
| ST_HausdorffDistance()                                                             | The discrete Hausdorff distance of one geometry<br>from another |  |
...
| ST_NumGeometries()                                | Return number of geometries in geometry<br>collection      |  |
...
| Construct Point from WKB<br>ST_PointFromWKB()     |                                                            |  |
...
| ST_SymDifference()                                | Return point set symmetric difference of two<br>geometries |  |
