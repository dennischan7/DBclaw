...
After completing the installation, do not yet start any of the binaries. We show you how to do so following the configuration of the nodes (see [Section 25.3.3,](#page-100-0) ["Initial Configuration of NDB Cluster"\)](#page-100-0).
...
The data directory on each machine hosting a data node is /usr/local/ mysql/data. This piece of information is essential when configuring the management node. (See [Section 25.3.3, "Initial Configuration of NDB Cluster"](#page-100-0).)
