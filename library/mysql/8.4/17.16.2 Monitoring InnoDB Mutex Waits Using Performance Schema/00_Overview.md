...
| mysql> SELECT EVENT_NAME, COUNT_STAR, SUM_TIMER_WAIT/1000000000 SUM_TIMER_WAIT_MS<br>FROM performance_schema.events_waits_summary_global_by_event_name<br>WHERE SUM_TIMER_WAIT > 0 AND EVENT_NAME LIKE 'wait/synch/mutex/innodb/%'<br>ORDER BY COUNT_STAR DESC;<br>++++ |            |                                |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------|--------------------------------|
| EVENT_NAME                                                                                                                                                                                                                                                              |            | COUNT_STAR   SUM_TIMER_WAIT_MS |
| ++++<br>  wait/synch/mutex/innodb/trx_mutex                                                                                                                                                                                                                             | <br>201111 | 23.4719                        |
...
# <span id="page-105-0"></span>**17.17 InnoDB Monitors**
