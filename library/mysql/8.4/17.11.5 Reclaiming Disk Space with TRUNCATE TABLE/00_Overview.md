...
# <span id="page-151-0"></span>**17.12 InnoDB and Online DDL**
...
- For in-place operations, the ability to adjust the balance between performance and concurrency during DDL operations using the LOCK clause. See [The LOCK clause.](#page-167-0)
...
# <span id="page-152-0"></span>**17.12.1 Online DDL Operations**
...
- [Index Operations](#page-152-1)
- [Primary Key Operations](#page-153-0)
- [Column Operations](#page-155-0)
- [Generated Column Operations](#page-160-0)
- [Foreign Key Operations](#page-161-0)
- [Table Operations](#page-162-0)
- [Tablespace Operations](#page-163-0)
- [Partitioning Operations](#page-164-0)

## <span id="page-152-1"></span>**Index Operations**

The following table provides an overview of online DDL support for index operations. An asterisk indicates additional information, an exception, or a dependency. For details, see [Syntax and Usage](#page-153-1) [Notes](#page-153-1).
...
### <span id="page-153-1"></span>**Syntax and Usage Notes**
...
Some factors affect the performance, space usage, and semantics of this operation. For details, see [Section 17.12.8, "Online DDL Limitations".](#page-173-1)
...
ALTER TABLE tbl\_name RENAME INDEX old\_index\_name TO new\_index\_name, ALGORITHM=INPLACE, LOCK=NONE;
...
# <span id="page-153-0"></span>**Primary Key Operations**

The following table provides an overview of online DDL support for primary key operations. An asterisk indicates additional information, an exception, or a dependency. See [Syntax and Usage Notes](#page-154-0).
...
### <span id="page-154-0"></span>**Syntax and Usage Notes**
...
# <span id="page-155-0"></span>**Column Operations**

The following table provides an overview of online DDL support for column operations. An asterisk indicates additional information, an exception, or a dependency. For details, see [Syntax and Usage](#page-156-0) [Notes](#page-156-0).
...
### <span id="page-156-0"></span>**Syntax and Usage Notes**
...
## <span id="page-160-0"></span>**Generated Column Operations**

The following table provides an overview of online DDL support for generated column operations. For details, see [Syntax and Usage Notes.](#page-160-1)
...
### <span id="page-160-1"></span>**Syntax and Usage Notes**
...
# <span id="page-161-0"></span>**Foreign Key Operations**

The following table provides an overview of online DDL support for foreign key operations. An asterisk indicates additional information, an exception, or a dependency. For details, see [Syntax and Usage](#page-161-1) [Notes](#page-161-1).
...
# <span id="page-161-1"></span>**Syntax and Usage Notes**
...
# <span id="page-162-0"></span>**Table Operations**

The following table provides an overview of online DDL support for table operations. An asterisk indicates additional information, an exception, or a dependency. For details, see [Syntax and Usage](#page-162-1) [Notes](#page-162-1).
...
Persistent statistics include STATS\_PERSISTENT, STATS\_AUTO\_RECALC, and STATS\_SAMPLE\_PAGES. For more information, see [Section 17.8.10.1, "Configuring Persistent](#page-110-0) [Optimizer Statistics Parameters"](#page-110-0).
...
## <span id="page-163-0"></span>**Tablespace Operations**

The following table provides an overview of online DDL support for tablespace operations. For details, see [Syntax and Usage Notes.](#page-164-1)
...
| Enabling or<br>disabling            | No      | Yes      | No                     | Yes               | No                        |

| Operation                                                              | Instant | In Place | Rebuilds Table Permits | Concurrent<br>DML | Only Modifies<br>Metadata |
|------------------------------------------------------------------------|---------|----------|------------------------|-------------------|---------------------------|
| general<br>tablespace<br>encryption                                    |         |          |                        |                   |                           |
...
## <span id="page-164-0"></span>**Partitioning Operations**
...
# <span id="page-167-1"></span>**17.12.2 Online DDL Performance and Concurrency**
...
# <span id="page-167-0"></span>**The LOCK clause**
...
# <span id="page-170-0"></span>**17.12.3 Online DDL Space Requirements**
