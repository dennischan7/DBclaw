...
The following are limitations specific to the [NDB](#page-50-0) storage engine:
...
- **Number of fragment replicas.** The number of fragment replicas, as determined by the [NoOfReplicas](#page-153-0) data node configuration parameter, is the number of copies of all data stored
...
Setting [NoOfReplicas](#page-153-0) to a value greater than 2 is supported (to a maximum of 4) but unnecessary to guard against loss of data.

See also [Section 25.2.7.10, "Limitations Relating to Multiple NDB Cluster Nodes"](#page-80-0).