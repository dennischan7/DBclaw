# Oracle 19c - PREDICTION_DETAILS
Source: https://docs.oracle.com/en/database/oracle/oracle-database/19/sqlrf/PREDICTION_DETAILS.html
...
* Syntax â Use the first syntax to score the data with a pre-defined model. Supply the name of a model that performs classification, regression, or anomaly detection.
