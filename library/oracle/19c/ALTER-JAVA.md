# Oracle 19c - ALTER-JAVA
Source: https://docs.oracle.com/en/database/oracle/oracle-database/19/sqlrf/ALTER-JAVA.html
...
Specify `IF EXISTS` to alter an existing JAVA object.
