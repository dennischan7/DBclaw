# Oracle 19c - CREATE-SEQUENCE
Source: https://docs.oracle.com/en/database/oracle/oracle-database/19/sqlrf/CREATE-SEQUENCE.html
...
* If the sequence does not exist, a new one is created at the end of the statement.
* If the sequence exists, it is detected and a new one is not created.
