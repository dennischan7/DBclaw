...
Source: https://docs.oracle.com/en/database/oracle/oracle-database/19/sqlrf/CREATE-PLUGGABLE-DATABASE.html
...
See [Oracle Multitenant Administratorâs Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/19/sqlrf&id=MULTI-GUID-B26D56E1-B958-444F-864C-8AFDFF1566A6)  for more information on the prerequisites to PDB creation.
...
This clause lets you grant one or more roles to the `PDB_DBA` role. Use this clause to grant roles that have the privileges required by the administrative user of the PDB. For `role`, specify a predefined role. For a list of predefined roles, refer to [Oracle Database Security Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/19/sqlrf&id=DBSEG4414).
