# Oracle 19c - CREATE-DATABASE
Source: https://docs.oracle.com/en/database/oracle/oracle-database/19/sqlrf/CREATE-DATABASE.html
...
If you do not specify these clauses, then Oracle Database creates the default password `change_on_install` for user `SYS` . You can change this password later with the statement `ALTER` `USER` .
