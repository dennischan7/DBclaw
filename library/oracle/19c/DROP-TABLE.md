...
* For a domain index, the appropriate drop routines are invoked. Refer to [Oracle Database Data Cartridge Developer's Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/19/sqlrf&id=ADDCI4200) for more information on these routines.
