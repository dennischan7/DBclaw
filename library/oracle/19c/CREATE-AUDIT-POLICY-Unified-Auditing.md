# Oracle 19c - CREATE-AUDIT-POLICY-Unified-Auditing
Source: https://docs.oracle.com/en/database/oracle/oracle-database/19/sqlrf/CREATE-AUDIT-POLICY-Unified-Auditing.html

This section describes the `CREATE` `AUDIT` `POLICY` statement for unified auditing. This type of auditing is new beginning with Oracle Database 12c and provides a full set of enhanced auditing features. Refer to [Oracle Database Security Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/19/sqlrf&id=DBSEG630) for more information on unified auditing.
...
Specify the name of the unified audit policy to be created. The name must satisfy the requirements listed in "[Database Object Naming Rules](Database-Object-Names-and-Qualifiers.md#GUID-75337742-67FD-4EC0-985F-741C93D918DA)".
...
Only those SQL statements are audited, that make successful use of system privileges. If a statement does not make use of a system privilege, it does not get audited with the `privilege_audit_clause`.
...
You can audit `CHANGE PASSWORD` system actions by configuring an audit policy to audit password changes. After configuring the audit ploicy, you must enable the audit policy.
...
Use this clause to audit actions for the following components: Oracle Data Pump, Oracle SQL\*Loader Direct Path Load, Oracle Label Security, Oracle Database Real Application Security, and Oracle Database Vault and the transmission protocol.
...
Refer to [Oracle Database Security Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/19/sqlrf&id=DBSEG928) for complete information on auditing Oracle Data Pump.
...
Refer to [Oracle Database Security Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/19/sqlrf&id=DBSEG120) for complete information on auditing Oracle SQL\*Loader Direct Path Load.
...
Refer to [Oracle Database Security Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/19/sqlrf&id=DBSEG454) for complete information on auditing Oracle Label Security.
...
Refer to [Oracle Database Security Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/19/sqlrf&id=DBSEG367) for complete information on auditing Oracle Database Real Application Security.
...
Refer to [Oracle Database Security Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/19/sqlrf&id=DBSEG419) for complete information on auditing Oracle Database Vault.
...
For more see [Database Security Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/19/sqlrf&id=DBSEG-GUID-D9A133FD-728C-4231-8870-A91280563D28).
...
See [31.4.4.11 Example: Auditing All Actions in the Database](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/19/sqlrf&id=DBSEG-GUID-2435D929-10AD-43C7-8A6C-5133170074D0) of the Database Security Guide for guidelines to audit database actions without generating a large volume of audit records.
