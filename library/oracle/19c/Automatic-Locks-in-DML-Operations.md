# Oracle 19c - Automatic-Locks-in-DML-Operations
Source: https://docs.oracle.com/en/database/oracle/oracle-database/19/sqlrf/Automatic-Locks-in-DML-Operations.html
...
The types of row and table locks are summarized here. For a more complete discussion of the types of row and table locks, see [Oracle Database Concepts](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/19/sqlrf&id=CNCPT1339).
...
| `UPDATE` `table` ... | Yes | SX | Y[Foot 1](#GUID-3D57596F-8B73-4C80-8F4D-79A12F781EFD__BABHAJFD) | Y[Foot 1](#fnsrc_d465783e476) | N | N | N |
| `MERGE` `INTO` `table` ... | Yes | SX | Y | Y | N | N | N |
| `DELETE` `FROM` `table` ... | Yes | SX | Y[Foot 1](#fnsrc_d465783e543) | Y[Foot 1](#fnsrc_d465783e548) | N | N | N |
| `SELECT` ... `FROM` `table` `FOR` `UPDATE` `OF` ... | Yes | SX | Y[Foot 1](#fnsrc_d465783e590) | Y[Foot 1](#fnsrc_d465783e595) | N | N | N |
