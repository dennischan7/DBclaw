# Oracle 12c - statements_5009
Source: https://docs.oracle.com/database/121/SQLRF/statements_5009.htm
...
[`ASM_DISKSTRING`](../REFRN/GUID-BF533461-03CF-42B0-9D9E-1E0AA1190826.md#REFRN10248)
...
Use this clause to set attribute values for the disk group. You can view the current attribute values by querying the `V$ASM_ATTRIBUTE` view. [Table 14-2](#BGEDFCIB) lists the attributes you can set with this clause. All attribute values are strings.

Table 14-2 Disk Group Attributes
