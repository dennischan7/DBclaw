# Oracle 12c - statements_4001
Source: https://docs.oracle.com/database/121/SQLRF/statements_4001.htm

Purpose

Triggers are defined using PL/SQL. Therefore, this section provides some general information but refers to [Oracle Database PL/SQL Language Reference](../LNPLS/alter_trigger.md#LNPLS99996) for details of syntax and semantics.
...
See [Oracle Database PL/SQL Language Reference](../LNPLS/alter_trigger.md#LNPLS1896) for the syntax and semantics of this clause and for complete information on creating and compiling triggers.
...
Use these clauses to specify whether the trigger becomes an editioned or noneditioned object if editioning is later enabled for the schema object type `TRIGGER` in `schema`. The default is `EDITIONABLE`. For information about altering editioned and noneditioned objects, see [Oracle Database Development Guide](../ADFNS/adfns_editions.md#ADFNS1287).
