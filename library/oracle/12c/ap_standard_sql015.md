# Oracle 12c - ap_standard_sql015
Source: https://docs.oracle.com/database/121/SQLRF/ap_standard_sql015.htm

# Character Set Support

Oracle supports most national, international, and vendor-specific encoded character set standards. A complete list of character sets supported by Oracle appears in [Oracle Database Globalization Support Guide](../NLSPG/applocaledata.md#NLSPG584).
...
Oracle Database 12c Release 1 (12.1.0.1) complies with version 6.1 of the Unicode Standard. Oracle Database 12c Release 1 (12.1.0.2) expands the compliance to version 6.2 of the Unicode Standard. For up-to-date information on the Unicode Standard, visit the Web site of the Unicode Consortium:
