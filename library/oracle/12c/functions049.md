# Oracle 12c - functions049
Source: https://docs.oracle.com/database/121/SQLRF/functions049.htm
...
[Oracle OLAP User's Guide](../OLAUG/query.md#OLAUG400)
...
The following examples require Oracle Database with the OLAP option and the `GLOBAL` sample schema. Refer to [Oracle OLAP User's Guide](../OLAUG/start.md#OLAUG9117) for information on downloading and installing the `GLOBAL` sample schema.
