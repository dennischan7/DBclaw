# Oracle 12c - functions258
Source: https://docs.oracle.com/database/121/SQLRF/functions258.htm
...
For an explanation of the `ENTITYESCAPING` and `NONENTITYESCAPING` keywords, refer to [Oracle XML DB Developer's Guide](../ADXDB/xdb13gen.md#ADXDB1620).
