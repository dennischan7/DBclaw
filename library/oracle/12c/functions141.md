# Oracle 12c - functions141
Source: https://docs.oracle.com/database/121/SQLRF/functions141.htm
...
The `MEDIAN` function is a specific case of `PERCENTILE_CONT` where the percentile value defaults to 0.5. For more information, refer to [MEDIAN](functions111.md#i1279886).
