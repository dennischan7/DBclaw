# Oracle 12c - statements_8005
Source: https://docs.oracle.com/database/121/SQLRF/statements_8005.htm
...
The `error_logging_clause` has the same behavior in `DELETE` statement as it does in an `INSERT` statement. Refer to the `INSERT` statement [error\_logging\_clause](statements_9015.md#BGBEIACB) for more information.
