# Oracle 12c - clauses004
Source: https://docs.oracle.com/database/121/SQLRF/clauses004.htm
...
If you are specifying an alias during file creation, then refer to [diskgroup\_directory\_clauses](statements_1009.md#i2175401) and [diskgroup\_alias\_clauses](statements_1009.md#i2168812) for instructions on specifying the full alias name.
...
The following statement adds a logfile group 5 with member log files on migration target disks `4k_disk_a` and `4k_disk_b`. After executing this statement, you can switch existing log files on disks with 512-byte block size to logs with 4K block size using the [switch\_logfile\_clause](statements_1006.md#BGBIGEHB).
