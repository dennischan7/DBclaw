# Oracle 12c - functions254
Source: https://docs.oracle.com/database/121/SQLRF/functions254.htm
...
Refer to the example for [XMLFOREST](functions260.md#i1172404) to compare the output of these two functions.