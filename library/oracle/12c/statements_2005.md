# Oracle 12c - statements_2005
Source: https://docs.oracle.com/database/121/SQLRF/statements_2005.htm
...
This clause has the same semantics in `CREATE` `OPERATOR` and `ALTER` `OPERATOR` statements. For full information, refer to [implementation\_clause](statements_6005.md#i2160229) in the documentation on `CREATE` `OPERATOR`.

context\_clause

This clause has the same semantics in `CREATE` `OPERATOR` and `ALTER` `OPERATOR` statements. For full information, refer to [context\_clause](statements_6005.md#i2152088) in the documentation on `CREATE` `OPERATOR`.

using\_function\_clause

This clause has the same semantics in `CREATE` `OPERATOR` and `ALTER` `OPERATOR` statements. For full information, refer to [using\_function\_clause](statements_6005.md#i2152100) in the documentation on `CREATE` `OPERATOR`.
...
You cannot use this clause to drop the only binding associated with this operator. Instead you must use the `DROP` `OPERATOR` statement. Refer to [DROP OPERATOR](statements_8025.md#i2067252) for more information.
