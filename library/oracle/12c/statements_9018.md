# Oracle 12c - statements_9018
Source: https://docs.oracle.com/database/121/SQLRF/statements_9018.htm
...
system\_privilege For `system_privilege`, specify the system privilege for which auditing is to be stopped. Refer to [Table 18-1](statements_9014.md#BABEFFEE) for a list of the system privileges and the statements they authorize.
...
DIRECT\_PATH LOAD Use this clause to discontinue auditing of SQL\*Loader direct path loads.
