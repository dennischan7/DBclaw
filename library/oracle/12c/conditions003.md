# Oracle 12c - conditions003
Source: https://docs.oracle.com/database/121/SQLRF/conditions003.htm
...
In both forms of floating-point condition, `expr` must resolve to a numeric data type or to any data type that can be implicitly converted to a numeric data type. [Table 6-3](#CJAFFCAE) describes the floating-point conditions.
