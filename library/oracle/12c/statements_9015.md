# Oracle 12c - statements_9015
Source: https://docs.oracle.com/database/121/SQLRF/statements_9015.htm
...
Inserting Values with a Subquery: Example The following statement copies employees whose commission exceeds 25% of their salary into the `bonuses` table, which was created in ["Merging into a Table: Example"](statements_9017.md#i2091840):
...
You can extract data from substitutable tables and columns using built-in functions and conditions. For examples, see the functions [TREAT](functions234.md#i1018806) and [SYS\_TYPEID](functions204.md#i1044156), and ["IS OF type Condition"](conditions015.md#i1051274).
