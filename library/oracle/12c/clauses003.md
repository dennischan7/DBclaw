# Oracle 12c - clauses003
Source: https://docs.oracle.com/database/121/SQLRF/clauses003.htm
...
* `ALTER` `INDEX`: to deallocate unused space from the index, an index partition, or an index subpartition (see [ALTER INDEX](statements_1012.md#i2050158)`)`
