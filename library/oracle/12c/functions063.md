# Oracle 12c - functions063
Source: https://docs.oracle.com/database/121/SQLRF/functions063.htm
...
`DUMP` returns a `VARCHAR2` value containing the data type code, length in bytes, and internal representation of `expr`. The returned result is always in the database character set. For the data type corresponding to each code, see [Table 2-1, "Built-in Data Type Summary"](sql_elements001.md#BABCGCHG).
