# Oracle 12c - functions139
Source: https://docs.oracle.com/database/121/SQLRF/functions139.htm
...
Refer to the related function [DEPTH](functions061.md#i1150333) for an example using both of these ancillary functions of the `EQUALS_PATH` and `UNDER_PATH` conditions.
