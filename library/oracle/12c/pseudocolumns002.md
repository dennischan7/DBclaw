# Oracle 12c - pseudocolumns002
Source: https://docs.oracle.com/database/121/SQLRF/pseudocolumns002.htm
...
Before you use `CURRVAL` for a sequence in your session, you must first initialize the sequence with `NEXTVAL`. Refer to [CREATE SEQUENCE](statements_6017.md#i2067093) for information on sequences.
