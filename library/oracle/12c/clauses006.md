# Oracle 12c - clauses006
Source: https://docs.oracle.com/database/121/SQLRF/clauses006.htm
...
* `CREATE` `CLUSTER` and `ALTER` `CLUSTER`: to set or alter parallelism for a cluster (see [CREATE CLUSTER](statements_5002.md#BABDBDEE) and [ALTER CLUSTER](statements_1005.md#BGEHGJBC)).
* `CREATE` `INDEX`: to set parallelism for the index (see [CREATE INDEX](statements_5013.md#i2062403)).
* `ALTER` `INDEX` (see [ALTER INDEX](statements_1012.md#i2050158)):
...
* `ALTER` `DATABASE` ... `RECOVER`: to recover the database (see [ALTER DATABASE](statements_1006.md#i2079942)).
* `ALTER` `DATABASE` ... `standby_database_clauses`: to parallelize operations on the standby database (see [ALTER DATABASE](statements_1006.md#i2079942)).
