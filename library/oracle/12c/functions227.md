# Oracle 12c - functions227
Source: https://docs.oracle.com/database/121/SQLRF/functions227.htm
...
The `'``nlsparam``'` argument in this function has the same purpose as it does in the `TO_CHAR` function for number conversions. Refer to [TO\_CHAR (number)](functions217.md#i79330) for more information.
