# Oracle 12c - functions166
Source: https://docs.oracle.com/database/121/SQLRF/functions166.htm
...
The `MOD` function is similar to `REMAINDER` except that it uses `FLOOR` in its formula, whereas `REMAINDER` uses `ROUND`. Refer to [MOD](functions113.md#i77996).
...
Using table `float_point_demo`, created for the `TO_BINARY_DOUBLE` ["Examples"](functions212.md#i1336203), the following example divides two floating-point numbers and returns the remainder of that operation:
