# Oracle 12c - statements_9017
Source: https://docs.oracle.com/database/121/SQLRF/statements_9017.htm
...
[Oracle Database Security Guide](../DBSEG/vpd.md#DBSEG249)
...
The error\_logging\_clause has the same behavior in a `MERGE` statement as in an `INSERT` statement. Refer to the `INSERT` statement [error\_logging\_clause](statements_9015.md#BGBEIACB) for more information.
