# Oracle 12c - statements_1010
Source: https://docs.oracle.com/database/121/SQLRF/statements_1010.htm
...
This clause has the same semantics as the [[NO] OPTIMIZE DATA](statements_5011.md#BGEIBJJB) clause of `CREATE` `FLASHBACK` `ARCHIVE`.
