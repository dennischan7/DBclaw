# Oracle 12c - functions111
Source: https://docs.oracle.com/database/121/SQLRF/functions111.htm
...
* [PERCENTILE\_CONT](functions141.md#i1000909), which returns, for a given percentile, the value that corresponds to that percentile by way of interpolation. `MEDIAN` is the specific case of `PERCENTILE_CONT` where the percentile value defaults to 0.5.
* [PERCENTILE\_DISC](functions142.md#i1000913), which is useful for finding values for a given percentile without interpolation.
