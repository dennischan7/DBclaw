# Oracle 12c - statements_9008
Source: https://docs.oracle.com/database/121/SQLRF/statements_9008.htm
...
Restriction on Dropping Users You cannot drop a user whose schema contains a table that uses a flashback data archive for historical tracking. You must first disable the table's use of the flashback data archive.
...
Restriction on Dropping Users You cannot drop a user whose schema contains a table that uses a flashback data archive. You must first disable use of the flashback data archive.
