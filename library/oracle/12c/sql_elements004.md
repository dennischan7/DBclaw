# Oracle 12c - sql_elements004
Source: https://docs.oracle.com/database/121/SQLRF/sql_elements004.htm
...
[Table 2-17](#g195443) shows whether the following statement meets the matching conditions for different values of `char` and '`fmt`' using `FX` (the table named `table` has a column `date_column` of data type `DATE`):
