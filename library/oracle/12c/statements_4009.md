# Oracle 12c - statements_4009
Source: https://docs.oracle.com/database/121/SQLRF/statements_4009.htm
...
Calling a Procedure: Example The following statement removes the Entertainment department (created in ["Inserting Sequence Values: Example"](statements_9015.md#i2102477)) using uses the `remove_dept` procedure. See [Oracle Database PL/SQL Language Reference](../LNPLS/create_package_body.md#LNPLS01381) for the example that creates this procedure.
