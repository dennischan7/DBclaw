# Oracle 12c - statements_9001
Source: https://docs.oracle.com/database/121/SQLRF/statements_9001.htm
...
Dropping a Sequence: Example The following statement drops the sequence `customers_seq` owned by the user `oe`, which was created in ["Creating a Sequence: Example"](statements_6017.md#i2092099). To issue this statement, you must either be connected as user `oe` or have the `DROP` `ANY` `SEQUENCE` system privilege:
