# Oracle 12c - functions151
Source: https://docs.oracle.com/database/121/SQLRF/functions151.htm
...
You can specify `cost_matrix_clause` as a biasing factor for minimizing the most harmful kinds of misclassifications. `cost_matrix_clause` behaves as described for ["PREDICTION\_COST"](functions148.md#CJABAJED).
