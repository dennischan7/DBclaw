# Oracle 12c - queries006
Source: https://docs.oracle.com/database/121/SQLRF/queries006.htm
...
In this example, `B`, the null-generated table, is outer-joined to two tables, `A` and `D`. Refer to [SELECT](statements_10002.md#i2065646) for the syntax for an outer join.
