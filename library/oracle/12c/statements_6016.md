# Oracle 12c - statements_6016
Source: https://docs.oracle.com/database/121/SQLRF/statements_6016.htm
...
This statement does not actually create a schema. Oracle Database automatically creates a schema when you create a user (see
