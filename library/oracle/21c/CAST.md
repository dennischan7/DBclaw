# Oracle 21c - CAST
Source: https://docs.oracle.com/en/database/oracle/oracle-database/21/sqlrf/CAST.html
...
| Destination Data Type | from BINARY\_FLOAT, BINARY\_DOUBLE | from CHAR, VARCHAR2 | from NUMBER/INTEGER | from DATETIME / INTERVAL (Note 1) | from RAW | from ROWID, UROWID (Note 2) | from NCHAR, NVARCHAR2 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| to BINARY\_FLOAT, BINARY\_DOUBLE | `X` (Note 3) | `X` (Note 3) | `X` (Note 3) | `--` | `--` | `--` | `X` (Note 3) |
