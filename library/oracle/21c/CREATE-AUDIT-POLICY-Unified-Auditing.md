# Oracle 21c - CREATE-AUDIT-POLICY-Unified-Auditing
Source: https://docs.oracle.com/en/database/oracle/oracle-database/21/sqlrf/CREATE-AUDIT-POLICY-Unified-Auditing.html

This section describes the `CREATE` `AUDIT` `POLICY` statement for unified auditing. This type of auditing is new beginning with Oracle Database 12c and provides a full set of enhanced auditing features. Refer to [Oracle Database Security Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/21/sqlrf&id=DBSEG630) for more information on unified auditing.
...
You can audit `CHANGE PASSWORD` system actions by configuring the audit policy and enabling the audit policy.
...
The audit policy `mypolicy` will now audit `CHANGE PASSWORD` actions for both successful and unsuccessful changes of password. A user `hr_usr` with password `hr_pwd` can log into PDB `hr_pdb` and change the password as follows:
...
In the SQL\*Plus example above, the command `PASSWORD` run by user `hr_usr` initiates a `CHANGE PASSWORD` action that generates an audit record. You can view the record by by querying the `UNIFIED_AUDIT_TRAIL` as follows:
...
Refer to [Oracle Database Security Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/21/sqlrf&id=DBSEG928) for complete information on auditing Oracle Data Pump.
...
Refer to [Oracle Database Security Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/21/sqlrf&id=DBSEG120) for complete information on auditing Oracle SQL\*Loader Direct Path Load.
...
Refer to [Oracle Database Security Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/21/sqlrf&id=DBSEG454) for complete information on auditing Oracle Label Security.
...
Refer to [Oracle Database Security Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/21/sqlrf&id=DBSEG367) for complete information on auditing Oracle Database Real Application Security.
...
Refer to [Oracle Database Security Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/21/sqlrf&id=DBSEG419) for complete information on auditing Oracle Database Vault.
...
For more see [Database Security Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/21/sqlrf&id=DBSEG-GUID-D9A133FD-728C-4231-8870-A91280563D28).
...
See [31.4.4.11 Example: Auditing All Actions in the Database](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/21/sqlrf&id=DBSEG-GUID-2435D929-10AD-43C7-8A6C-5133170074D0) of the Database Security Guide for guidelines to audit database actions without generating a large volume of audit records.
