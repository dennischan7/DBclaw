# Oracle 21c - ASSOCIATE-STATISTICS
Source: https://docs.oracle.com/en/database/oracle/oracle-database/21/sqlrf/ASSOCIATE-STATISTICS.html
...
This statement creates an association for the standalone package `emp_mgmt`. See [Oracle Database PL/SQL Language Reference](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/21/sqlrf&id=LNPLS01378) for the example that creates this package.
