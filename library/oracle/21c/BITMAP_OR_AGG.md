# Oracle 21c - BITMAP_OR_AGG
Source: https://docs.oracle.com/en/database/oracle/oracle-database/21/sqlrf/BITMAP_OR_AGG.html
...
. The argument is expected to be a bitmap produced by
