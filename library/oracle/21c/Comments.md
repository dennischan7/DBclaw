# Oracle 21c - Comments
Source: https://docs.oracle.com/en/database/oracle/oracle-database/21/sqlrf/Comments.html
...
With 19c you can use `DBMS_XPLAN` to find out whether a hint is used or not used. For more information, see the [Database SQL Tuning Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/21/sqlrf&id=TGSQL).
