# Oracle 21c - CUBE_TABLE
Source: https://docs.oracle.com/en/database/oracle/oracle-database/21/sqlrf/CUBE_TABLE.html
...
Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/21/sqlrf&id=OLAUG9117) for information on downloading and installing the `GLOBAL` sample schema.
