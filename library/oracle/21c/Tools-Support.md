# Oracle 21c - Tools-Support
Source: https://docs.oracle.com/en/database/oracle/oracle-database/21/sqlrf/Tools-Support.html
...
Reference](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/21/sqlrf&id=SQPUG).