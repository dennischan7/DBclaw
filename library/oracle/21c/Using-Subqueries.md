# Oracle 21c - Using-Subqueries
Source: https://docs.oracle.com/en/database/oracle/oracle-database/21/sqlrf/Using-Subqueries.html
...
* To define a table to be operated on by a containing query
  ...
  Subqueries so used can employ correlation variables, both defined within the subquery itself and those defined in query blocks containing the subquery. Refer to [table\_collection\_expression](SELECT.md#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__I2104990) for more information.
