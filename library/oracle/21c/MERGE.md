# Oracle 21c - MERGE
Source: https://docs.oracle.com/en/database/oracle/oracle-database/21/sqlrf/MERGE.html
...
The following statements demonstrate the use of bind variables to insert a new row into the `people_target`:
