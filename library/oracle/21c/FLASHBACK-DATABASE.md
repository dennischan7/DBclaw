# Oracle 21c - FLASHBACK-DATABASE
Source: https://docs.oracle.com/en/database/oracle/oracle-database/21/sqlrf/FLASHBACK-DATABASE.html
...
You can determine the current SCN by querying the `CURRENT_SCN` column of the [`V$DATABASE`](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/21/sqlrf&id=REFRN30047) view. This in turn lets you save the SCN to a spool file, for example, before running a high-risk batch job.
