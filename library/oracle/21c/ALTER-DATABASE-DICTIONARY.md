# Oracle 21c - ALTER-DATABASE-DICTIONARY
Source: https://docs.oracle.com/en/database/oracle/oracle-database/21/sqlrf/ALTER-DATABASE-DICTIONARY.html
...
* The TDE keystore must exist. The DDL first checks that the TDE:
  ...
  + Master Encryption Key exists in the TDE keystore.
    ...
    If any of the checks fail, the DDL fails. When this happens you must create a TDE keystore and provision a TDE Master Key. For more see the [Database Security Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/21/sqlrf&id=DBSEG).
