# Oracle 21c - CREATE-DIMENSION
Source: https://docs.oracle.com/en/database/oracle/oracle-database/21/sqlrf/CREATE-DIMENSION.html
...
Specify this clause to indicate that if the specified level is `NULL`, then the level is to be skipped. This clause lets you preserve the hierarchical chain of parent-child relationship by an alternative path that skips over the specified level. See [hierarchy\_clause](CREATE-DIMENSION.md#GUID-E6CD4CFC-5D06-4A8F-9DF1-C609A7EB8413__I2061857).
