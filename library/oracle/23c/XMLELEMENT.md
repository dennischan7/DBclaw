# Oracle 23c - XMLELEMENT
Source: https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/XMLELEMENT.html
...
For an explanation of the `ENTITYESCAPING` and `NONENTITYESCAPING` keywords, refer to [Oracle XML DB Developer's Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/26/sqlrf&id=ADXDB1620).
