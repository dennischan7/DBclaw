# Oracle 23c - Format-Models
Source: https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/Format-Models.html

|  |  |  |
| --- | --- | --- |
| ``` - / , . ; : "text" ``` | Yes | Punctuation and quoted text is reproduced in the result |
| ``` AD A.D. ``` | Yes | Gregorian calendar era indicator with or without periods  [Foot 1](#GUID-EAB212CF-C525-4ED8-9D3F-C76D08EEBC7A__FN_JS2_VTG_W2C) |
| ``` AM A.M. ``` | Yes | Meridian indicator with or without periods  [Foot 1](#fnsrc_d58550e2095) |
| ``` BC B.C. ``` | Yes | Gregorian calendar era indicator with or without periods  [Foot 1](#fnsrc_d58550e2108) |
...
| ``` PM P.M. ``` | Yes | Meridian indicator with or without periods  [Foot 1](#fnsrc_d58550e2484) |
