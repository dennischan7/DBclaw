# Oracle 23c - UPDATE
Source: https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/UPDATE.html
...
Specify a complete or partial name of a database link to a remote database where the object is located. You can use a database link to update a remote object only if you are using the database distributed functionality.
...
If you insert string literals into a `RAW` column, then during subsequent queries, the database will perform a full table scan rather than using any index that might exist on the `RAW` column.
...
See [order\_by\_clause](Analytic-Functions.md#GUID-527832F7-63C0-4445-8C16-307FA5084056__GUID-666C34CD-99A1-4974-A898-AD1ACD8CA42E)
