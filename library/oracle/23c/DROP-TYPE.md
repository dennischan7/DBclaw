# Oracle 23c - DROP-TYPE
Source: https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/DROP-TYPE.html

Purpose

Object types are defined using PL/SQL. Refer to [Oracle Database PL/SQL Language Reference](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/26/sqlrf&id=LNPLS99989) for complete information on creating, altering, and dropping object types.
...
Refer to [Managing Tables](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/26/sqlrf&id=ADMIN-GUID-16E1CE4C-0189-4CF5-8047-F5039587D130) .
...
The following statement removes object type `person_t`. See [Oracle Database PL/SQL Language Reference](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/26/sqlrf&id=LNPLS01383) for the example that creates this object type. Any columns that are dependent on person\_t are marked `UNUSED` and become inaccessible.
