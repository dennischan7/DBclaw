# Oracle 23c - DROP-PACKAGE
Source: https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/DROP-PACKAGE.html

Purpose

Packages are defined using PL/SQL. Refer to [Oracle Database PL/SQL Language Reference](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/26/sqlrf&id=LNPLS99992) for complete information on creating, altering, and dropping packages.
