# Oracle 23c - SET-CONSTRAINTS
Source: https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/SET-CONSTRAINTS.html
...
You can use `SET CONSTRAINTS` for SQL assertions. When you use it for SQL assertions, you must ensure that constraint names and assertion names are unique so they can live in the same namespace.
