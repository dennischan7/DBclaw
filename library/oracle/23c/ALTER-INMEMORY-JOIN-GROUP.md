# Oracle 23c - ALTER-INMEMORY-JOIN-GROUP
Source: https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/ALTER-INMEMORY-JOIN-GROUP.html
...
You can view existing join groups by querying the `DBA_JOINGROUPS` or `USER_JOINGROUPS` data dictionary view. Refer to [Oracle Database Reference](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/26/sqlrf&id=REFRN-GUID-285814BC-3BE0-47DA-8832-779229D5A93A) for more information on these views.
