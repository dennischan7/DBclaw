# Oracle 23c - TO_CHAR-datetime
Source: https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/TO_CHAR-datetime.html
...
Using TO\_CHAR to Format Dates and Numbers: Example
...
TO\_CHAR (datetime) Function: Example
