# Oracle 23c - CREATE-ANALYTIC-VIEW
Source: https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/CREATE-ANALYTIC-VIEW.html
...
Specify the schema in which to create the analytic view. If you do not specify a schema, then the database creates the analytic view in your own schema.
