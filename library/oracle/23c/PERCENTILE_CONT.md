# Oracle 23c - PERCENTILE_CONT
Source: https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/PERCENTILE_CONT.html
...
* Set the `APPROX_FOR_PERCENTILE` initialization parameter to `PERCENTILE_CONT` or `ALL` before using the `PERCENTILE_CONT` function. Refer to [Oracle Database Reference](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/26/sqlrf&id=REFRN-GUID-3872A78C-9B3F-457C-AD28-4E86F71AE74D) for more information on this parameter.
