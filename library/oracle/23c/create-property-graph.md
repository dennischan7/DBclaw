# Oracle 23c - create-property-graph
Source: https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/create-property-graph.html
...
graph\_element\_name\_and\_key::=

graph\_element\_object\_name::=

graph\_table\_label\_and\_properties::=

graph\_table\_label\_properties\_clause::=

graph\_table\_properties\_alternatives::=

graph\_table\_label\_clause::=

vertex\_table\_reference::=
...
* One or more column names used to explicitly specify the columns of the underlying object that are used to identify a row in that underlying object.
...
```
CREATE PROPERTY GRAPH "mygraph"
  VERTEX TABLES ("myschema". "mytable" LABEL âfooâ LABEL âbarâ);
```
