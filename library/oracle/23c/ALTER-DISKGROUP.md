# Oracle 23c - ALTER-DISKGROUP
Source: https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/ALTER-DISKGROUP.html

Note:

This SQL statement is valid only if you are using Oracle ASM and you have started an Oracle ASM instance. You must issue this statement from within the Oracle ASM instance, not from a normal database instance. For information on starting an Oracle ASM instance, refer to [Oracle Automatic Storage Management Administrator's Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/26/sqlrf&id=OSTMG036).
...
Specify the name of the disk group you want to modify. To determine the names of existing disk groups, query the [`V$ASM_DISKGROUP`](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/26/sqlrf&id=REFRN30171) dynamic performance view.
...
To determine the names of the disks already in this disk group, query the [`V$ASM_DISK`](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/26/sqlrf&id=REFRN30170) dynamic performance view.
...
The rebalance operation invoked when a disk is dropped is time consuming, whether or not you specify `FORCE` or `NOFORCE`. You can monitor the progress by querying the [`V$ASM_OPERATION`](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/26/sqlrf&id=REFRN30173) dynamic performance view. Refer to [rebalance\_diskgroup\_clause](ALTER-DISKGROUP.md#GUID-22D73AB6-7063-4627-A2ED-18D521ED2557__I2168800) for more information on rebalance operations.
...
See [Oracle Automatic Storage Management Administrator's Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/26/sqlrf&id=OSTMG-GUID-020ABD10-8370-444C-9B44-71F2FF688861) for more information on the phases of a rebalance operation.
...
Use this clause to add one or more named templates to a disk group. To determine the names of existing templates, query the [`V$ASM_TEMPLATE`](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/26/sqlrf&id=REFRN30174) dynamic performance view.
...
Use this clause to drop a directory for hierarchically named aliases. Oracle ASM will not drop the directory if it contains any alias definitions unless you also specify `FORCE`. This clause is not valid for dropping directories created as part of a system alias. Such directories are labeled with the value `Y` in the `SYSTEM_CREATED` column of the [`V$ASM_ALIAS`](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/26/sqlrf&id=REFRN30168) dynamic performance view.

RENAME DIRECTORY

Use this clause to change the name of a directory for hierarchically named aliases. This clause is not valid for renaming directories created as part of a system alias. Such directories are labeled with the value `Y` in the `SYSTEM_CREATED` column of the [`V$ASM_ALIAS`](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/26/sqlrf&id=REFRN30168) dynamic performance view.
...
You cannot drop or rename a system-generated alias. To determine whether an alias was system generated, query the `SYSTEM_CREATED` column of the [`V$ASM_ALIAS`](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/26/sqlrf&id=REFRN30168) dynamic performance view.
...
For `asm_volume`, specify the name of the volume. The name can contain only alphanumeric characters and the first character must be alphabetic. The maximum length of the name is platform dependent. Refer to [Oracle Automatic Storage Management Administrator's Guide](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/26/sqlrf&id=OSTMG94739) for more information.
...
[`V$ASM_OPERATION`](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/26/sqlrf&id=REFRN30173) for more information on the details of long-running Oracle ASM operations
...
[`ASM_DISKGROUPS`](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/26/sqlrf&id=REFRN10247) for more information about adding disk group names to the initialization parameter file
