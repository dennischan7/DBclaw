# Oracle 11g - statements_5014
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/statements_5014.htm
...
clause implicitly supplied the keyword

`SELECT`

. This is no longer the case. However, the subquery without the keyword
...
Restriction on the key\_for\_BLOB Clause For you to use this case, the table `CREATE$JAVA$LOB$TABLE` must exist in the current schema and must have a column LOB of type `BLOB` and a column `NAME` of type `VARCHAR2`.
