# Oracle 11g - statements_4008
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/statements_4008.htm
...
Calling a Procedure: Example The following statement removes the Entertainment department (created in ["Inserting Sequence Values: Example"](statements_9014.md#i2102477)) using uses the `remove_dept` procedure. See [Oracle Database PL/SQL Language Reference](../../appdev.112/e25519/create_package_body.md#LNPLS01381) for the example that creates this procedure.
