# Oracle 11g - functions099
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/functions099.htm
...
* [PERCENTILE\_CONT](functions127.md#i1000909), which returns, for a given percentile, the value that corresponds to that percentile by way of interpolation. `MEDIAN` is the specific case of `PERCENTILE_CONT` where the percentile value defaults to 0.5.
* [PERCENTILE\_DISC](functions128.md#i1000913), which is useful for finding values for a given percentile without interpolation.
