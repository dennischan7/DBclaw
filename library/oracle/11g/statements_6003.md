# Oracle 11g - statements_6003
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/statements_6003.htm
...
Note that only new materialized view logs can take advantage of `COMMIT` `SCN`. Existing materialized view logs cannot be altered to add `COMMIT` `SCN` unless they are dropped and recreated. Refer to [Oracle Database Data Warehousing Guide](../../server.112/e25554/refresh.md#DWHSG0319) for more information.
