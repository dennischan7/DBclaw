# Oracle 11g - functions188
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/functions188.htm
...
You can use the `SYS_TYPEID` function to create an index on the type-discriminant column of a table. For an example, see ["Indexing on Substitutable Columns: Examples"](statements_5012.md#i2089060).