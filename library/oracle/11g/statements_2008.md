# Oracle 11g - statements_2008
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/statements_2008.htm
...
Refer to [CREATE PROFILE](statements_6010.md#i2065930) and to the examples in the next section for more information.

Examples

Making a Password Unavailable: Example The following statement makes the password of the `new_profile` profile (created in ["Creating a Profile: Example"](statements_6010.md#i2092094)) unavailable for reuse for 90 days:
...
Setting Default Password Values: Example The following statement defaults the `PASSWORD_REUSE_TIME` value of the `app_user` profile (created in ["Setting Profile Resource Limits: Example"](statements_6010.md#i2120023)) to its defined value in the `DEFAULT` profile:
