# Oracle 11g - ap_syntx001
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/ap_syntx001.htm
...
| `condition` | The substitution value must be a condition that evaluates to `TRUE` or `FALSE`. See the syntax description of `condition` in [Chapter 7, "Conditions"](conditions.md#g1077361). | `last_name >'A'` |
