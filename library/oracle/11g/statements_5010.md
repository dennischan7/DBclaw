# Oracle 11g - statements_5010
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/statements_5010.htm
...
Specify `OPTIMIZE` `DATA` to instruct the database to optimize the storage of data in history tables using any of the following features: Advanced Row Compression, Advanced LOB Compression, Advanced LOB Deduplication, segment-level compression tiering, and row-level compression tiering.
