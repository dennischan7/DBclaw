# Oracle 11g - functions176
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/functions176.htm
...
STATS\_T\_TEST\_ONE Example The following example determines the significance of the difference between the average list price and the constant value 60:
...
## STATS\_T\_TEST\_INDEP and STATS\_T\_TEST\_INDEPU
...
STATS\_T\_TEST\_INDEPU Example The following example determines the significance of the difference between the average sales to men and women where the distributions are known to have significantly different (unpooled) variances:
