# Oracle 11g - statements_6002
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/statements_6002.htm
...
Use this clause to encrypt this column of the materialized view. Refer to the `CREATE` `TABLE` clause [encryption\_spec](statements_7002.md#CEGDFHBD) for more information on column encryption.
...
`CREATE` `TABLE` [table\_compression](statements_7002.md#i2128733)
...
Creating Materialized Aggregate Views: Example The following statement creates and populates a materialized aggregate view on the sample `sh.sales` table and specifies the default refresh method, mode, and time. It uses the materialized view log created in ["Creating a Materialized View Log: Examples"](statements_6003.md#i2098404), as well as the two additional logs shown here:
