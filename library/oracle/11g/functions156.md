# Oracle 11g - functions156
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/functions156.htm
...
You cannot nest analytic functions by using `ROW_NUMBER` or any other analytic function for `expr`. However, you can use other built-in function expressions for `expr`. Refer to ["About SQL Expressions"](expressions001.md#i1002626) for information on valid forms of `expr`.
