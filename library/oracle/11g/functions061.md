# Oracle 11g - functions061
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/functions061.htm
...
[XMLTABLE](functions253.md#CIHGGHFB)

,

[XMLCAST](functions236.md#CIHHHACJ)
...
The following example takes as input the same arguments as the example for [EXTRACT (XML)](functions060.md#i1006712). Instead of returning an XML fragment, as does the `EXTRACT` function, it returns the scalar value of the XML fragment:
