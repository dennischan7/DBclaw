# Oracle 11g - queries002
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/queries002.htm
...
You can use comments in a `SELECT` statement to pass instructions, or hints, to the Oracle Database optimizer. The optimizer uses hints to choose an execution plan for the statement. Refer to ["Hints"](sql_elements006.md#i35922) for more information on hints.