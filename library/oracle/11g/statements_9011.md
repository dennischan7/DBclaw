# Oracle 11g - statements_9011
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/statements_9011.htm
...
You can determine the current SCN by querying the `CURRENT_SCN` column of the [`V$DATABASE`](../../server.112/e40402/dynviews_1097.md#REFRN30047) view. This in turn lets you save the SCN to a spool file, for example, before running a high-risk batch job.
