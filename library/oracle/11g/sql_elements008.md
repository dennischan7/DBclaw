# Oracle 11g - sql_elements008
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/sql_elements008.htm
...
7. Nonquoted identifiers can contain only alphanumeric characters from your database character set and the underscore (\_), dollar sign ($), and pound sign (#). Database links can also contain periods (.) and "at" signs (@). Oracle strongly discourages you from using $ and # in nonquoted identifiers.
