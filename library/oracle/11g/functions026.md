# Oracle 11g - functions026
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/functions026.htm
...
function (either with or without the optional

`USING` `NCHAR_CS`

clause) results in code that is not portable between ASCII- and EBCDIC-based machine architectures.
