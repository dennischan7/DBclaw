# Oracle 11g - statements_8001
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/statements_8001.htm

# CREATE TYPE

Purpose

Object types are defined using PL/SQL. Therefore, this section provides some general information but refers to [Oracle Database PL/SQL Language Reference](../../appdev.112/e25519/create_type.md#LNPLS01375) for details of syntax and semantics.
...
See [Oracle Database PL/SQL Language Reference](../../appdev.112/e25519/create_type.md#LNPLS01375) for the syntax and semantics of the `plsql_source`.