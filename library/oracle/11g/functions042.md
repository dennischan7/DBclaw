# Oracle 11g - functions042
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/functions042.htm
...
[Oracle OLAP User's Guide](../../olap.112/e17123/query.md#OLAUG400)

for information about dimensional objects and about the tables generated by
...
The following examples require Oracle Database with the OLAP option and the `GLOBAL` sample schema. Refer to [Oracle OLAP User's Guide](../../olap.112/e17123/start.md#OLAUG9117) for information on downloading and installing the `GLOBAL` sample schema.
