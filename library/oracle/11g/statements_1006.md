# Oracle 11g - statements_1006
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/statements_1006.htm

Semantics

The following keywords, parameters, and clauses have meaning unique to `ALTER` `DIMENSION`. Keywords, parameters, and clauses that do not appear here have the same functionality that they have in the `CREATE` `DIMENSION` statement. Refer to [CREATE DIMENSION](statements_5006.md#i2061755) for more information.
