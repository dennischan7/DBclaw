# Oracle 11g - clauses001
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/clauses001.htm
...
* `ALTER` `INDEX`: to allocate an extent to the index, an index partition, or an index subpartition (see [ALTER INDEX](statements_1010.md#i2050158))
