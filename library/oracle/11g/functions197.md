# Oracle 11g - functions197
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/functions197.htm
...
Using table `float_point_demo` created for [TO\_BINARY\_DOUBLE](functions196.md#i1279235), the following example converts a value of data type `NUMBER` to a value of data type `BINARY_FLOAT`:
