# Oracle 11g - ap_locks001
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/ap_locks001.htm
...
The types of row and table locks are summarized here. For a more complete discussion of the types of row and table locks, see [Oracle Database Concepts](../../server.112/e40540/consist.md#CNCPT1339).
...
Oracle Database automatically obtains row-level and table-level locks on behalf of DML operations. The type of operation determines the locking behavior. [Table B-1](#BABCJIAJ) summarizes the information in this section.
...
can sometimes be exclusive (X) locks for a short time owing to side effects from constraints.
