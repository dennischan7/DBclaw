# Oracle 11g - statements_2011
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/statements_2011.htm
...
The following examples use the `rbs_one` rollback segment, which was created in ["Creating a Rollback Segment: Example"](statements_6013.md#CCHIHJDF).
...
Resizing a Rollback Segment: Example This statement shrinks the rollback segment `rbs_one`:
