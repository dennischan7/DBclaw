# Oracle 11g - statements_4010
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/statements_4010.htm
...
* You can roll back (undo) any changes made during the transaction with the `ROLLBACK` statement (see [ROLLBACK](statements_9021.md#i2104635)).
...
[COMMENT](statements_4009.md#i2119719)

for more information on adding comments to SQL statements
...
If you omit this clause, then the behavior of the commit operation is controlled by the
