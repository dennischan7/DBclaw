# Oracle 11g - statements_2003
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/statements_2003.htm
...
The syntax and general functioning of the partitioning clauses is the same as described for the `ALTER` `TABLE` statement. Refer to [alter\_table\_partitioning](statements_3001.md#i2085640) in the documentation for `ALTER` `TABLE`.
