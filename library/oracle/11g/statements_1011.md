# Oracle 11g - statements_1011
Source: https://docs.oracle.com/cd/E11882_01/server.112/e41084/statements_1011.htm
...
This clause has the same behavior when altering an indextype that it has when you are creating an indextype. Refer to the `CREATE` `INDEXTYPE` [storage\_table\_clause](statements_5013.md#BABEHBBD) for more information.

WITH LOCAL PARTITION

This clause has the same behavior when altering an indextype that it has when you create an indextype. Refer to the `CREATE` `INDEXTYPE` clause [WITH LOCAL PARTITION](statements_5013.md#BABBFIDC) for more information.