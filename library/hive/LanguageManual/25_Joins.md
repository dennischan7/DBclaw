...
See [Select Syntax](https://cwiki.apache.org/confluence/display/Hive/LanguageManual+Select#LanguageManualSelect-SelectSyntax "/confluence/display/Hive/LanguageManual+Select#LanguageManualSelect-SelectSyntax") for the context of this join syntax.

Version 0.13.0+: Implicit join notation

Implicit join notation is supported starting with Hive 0.13.0 (see [HIVE-5558](https://issues.apache.org/jira/browse/HIVE-5558 "https://issues.apache.org/jira/browse/HIVE-5558")). This allows the FROM clause to join a comma-separated list of tables, omitting the JOIN keyword. For example:
...
Complex expressions in ON clause are supported, starting with Hive 2.2.0 (see [HIVE-15211](https://issues.apache.org/jira/browse/HIVE-15211 "https://issues.apache.org/jira/browse/HIVE-15211"), [HIVE-15251](https://issues.apache.org/jira/browse/HIVE-15251 "https://issues.apache.org/jira/browse/HIVE-15251")). Prior to that, Hive did not support join conditions that are not equality conditions.
...
See [Hive Outer Join Behavior](https://cwiki.apache.org/confluence/display/Hive/OuterJoinBehavior "/confluence/display/Hive/OuterJoinBehavior") for information about predicate pushdown in outer joins.
