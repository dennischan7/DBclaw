...
LZO is a lossless data compression library that favors speed over compression ratio. See [http://www.oberhumer.com/opensource/lzo](http://www.oberhumer.com/opensource/lzo "http://www.oberhumer.com/opensource/lzo") and [http://www.lzop.org](http://www.lzop.org "http://www.lzop.org") for general information about LZO and see [Compressed Data Storage](https://cwiki.apache.org/confluence/display/Hive/CompressedStorage "/confluence/display/Hive/CompressedStorage") for information about compression in Hive.
...
See [CREATE TABLE](https://cwiki.apache.org/confluence/display/Hive/LanguageManual+DDL#LanguageManualDDL-CreateTable "/confluence/display/Hive/LanguageManual+DDL#LanguageManualDDL-CreateTable") and [Hive CLI](https://cwiki.apache.org/confluence/display/Hive/LanguageManual+Cli "/confluence/display/Hive/LanguageManual+Cli") for information about command syntax.
