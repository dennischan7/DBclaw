...
title: 36.3.1. Executing SQL Statements
---
...
SELECT statements that return a single result row can also be executed using EXEC SQL directly. To handle result sets with multiple rows, an application has to use a cursor; see [Section 36.3.2](#page-51-0) below. (As a special case, an application can fetch multiple rows at once into an array host variable; see [Section 36.4.4.3.1](#page-59-0).)
...
The tokens of the form :something are *host variables*, that is, they refer to variables in the C program. They are explained in [Section 36.4](#page-53-0).

## <span id="page-51-0"></span>**36.3.2. Using Cursors**
...
For more details about declaring a cursor, see [DECLARE;](#page-118-0) for more details about fetching rows from a cursor, see FETCH.
