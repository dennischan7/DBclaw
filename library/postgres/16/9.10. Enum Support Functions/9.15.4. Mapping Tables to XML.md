...
# <span id="page-159-0"></span>**9.16. JSON Functions and Operators**
...
<sup>3</sup> <https://datatracker.ietf.org/doc/html/rfc7159>

- Generating JSON objects and arrays from relational data.
- Querying JSON data using SQL/JSON query functions and SQL/JSON path language expressions.

To learn more about the SQL/JSON standard, see [sqltr-19075-6]. For details on JSON types supported in PostgreSQL, see [Section 8.14](#page-17-0).