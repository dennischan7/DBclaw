...
<span id="page-73-0"></span>[Table 36.2](#page-73-0) shows the allowed input formats.
...
[Table 36.3](#page-75-0) indicates a few possible formats. This will give you an idea of how to use this function. All output lines are based on the same date: November 23, 1959.

<span id="page-75-0"></span>**Table 36.3. Valid Input Formats for PGTYPESdate\_fmt\_asc**
...
<span id="page-76-1"></span>PGTYPESdate\_defmt\_asc
...
<span id="page-76-0"></span>[Table 36.4](#page-76-0) indicates a few possible formats. This will give you an idea of how to use this function.
