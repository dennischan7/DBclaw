...
If a query is expected to return more than one result row, a cursor should be used, as in the following example. (See [Section 36.3.2](#page-51-0) for more details about the cursor.)
...
# <span id="page-69-0"></span>**36.6. pgtypes Library**
