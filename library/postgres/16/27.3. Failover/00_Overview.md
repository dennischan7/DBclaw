...
To trigger failover of a log-shipping standby server, run pg\_ctl promote or call pg\_promote(). If you're setting up reporting servers that are only used to offload read-only queries from the primary, not for high availability purposes, you don't need to promote.

# <span id="page-24-0"></span>**27.4. Hot Standby**
