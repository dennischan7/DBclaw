...
The AT TIME ZONE operator converts time stamp *without* time zone to/from time stamp *with* time zone, and time with time zone values to different time zones. [Table 9.34](#page-124-0) shows its variants.

### <span id="page-124-0"></span>**Table 9.34. AT TIME ZONE Variants**
...
In these expressions, the desired time zone zone can be specified either as a text value (e.g., 'America/Los\_Angeles') or as an interval (e.g., INTERVAL '-08:00'). In the text case, a time zone name can be specified in any of the ways described in [Section 8.5.3](#page-0-0). The interval case is only useful for zones that have fixed offsets from UTC, so it is not very common in practice.
...
## <span id="page-125-0"></span>**9.9.5. Current Date/Time**
