...
To terminate an individual session while allowing other sessions to continue, use pg\_terminate\_backend() (see Table 9.90) or send a SIGTERM signal to the child process associated with the session.