...
Enables or disables the query planner's use of index-scan and index-only-scan plan types. The default is on. Also see [enable\\_indexonlyscan.](#page-77-0)

```
enable_indexonlyscan (boolean)
```

Enables or disables the query planner's use of index-only-scan plan types (see Section 11.9). The default is on. The [enable\\_indexscan](#page-77-1) setting must also be enabled to have the query planner consider index-only-scans.
...
## <span id="page-79-0"></span>**20.7.2. Planner Cost Constants**
...
## <span id="page-81-1"></span>**20.7.3. Genetic Query Optimizer**
...
## <span id="page-82-0"></span>**20.7.4. Other Planner Options**
...
Setting this value to [geqo\\_threshold](#page-81-0) or more may trigger use of the GEQO planner, resulting in non-optimal plans. See [Section 20.7.3.](#page-81-1)
