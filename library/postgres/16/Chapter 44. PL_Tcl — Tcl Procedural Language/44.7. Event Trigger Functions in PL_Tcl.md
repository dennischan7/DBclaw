...
## <span id="page-21-0"></span>**44.8. Error Handling in PL/Tcl**
...
## <span id="page-22-0"></span>**44.9. Explicit Subtransactions in PL/Tcl**

Recovering from errors caused by database access as described in [Section 44.8](#page-21-0) can lead to an undesirable situation where some operations succeed before one of them fails, and after recovering from that error the data is left in an inconsistent state. PL/Tcl offers a solution to this problem in the form of explicit subtransactions.
