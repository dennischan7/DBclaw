...
# <span id="page-134-0"></span>**33.3. Variant Comparison Files**
...
# <span id="page-135-0"></span>**33.4. TAP Tests**
...
The TAP tests require the Perl module IPC::Run. This module is available from [CPAN](https://metacpan.org/dist/IPC-Run)<sup>1</sup> or an operating system package. They also require PostgreSQL to be configured with the option --enable-tap-tests.
