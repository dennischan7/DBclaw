...
## <span id="page-113-0"></span>**ALLOCATE DESCRIPTOR**
...
[DEALLOCATE DESCRIPTOR,](#page-117-0) [GET DESCRIPTOR,](#page-123-0) [SET DESCRIPTOR](#page-130-0)

## <span id="page-114-0"></span>**CONNECT**
...
[DISCONNECT](#page-121-0), [SET CONNECTION](#page-129-0)

## <span id="page-117-0"></span>**DEALLOCATE DESCRIPTOR**
...
[ALLOCATE DESCRIPTOR](#page-113-0), [GET DESCRIPTOR](#page-123-0), [SET DESCRIPTOR](#page-130-0)

## <span id="page-118-0"></span>**DECLARE**
...
[CONNECT](#page-114-0), [DECLARE](#page-118-0), [OPEN](#page-126-0)
...
[ALLOCATE DESCRIPTOR](#page-113-0), [GET DESCRIPTOR](#page-123-0)

## <span id="page-121-0"></span>**DISCONNECT**
...
[CONNECT](#page-114-0), [SET CONNECTION](#page-129-0)
...
## <span id="page-123-0"></span>**GET DESCRIPTOR**
...
A token identifying which item of information about a column to retrieve. See [Section 36.7.1](#page-83-2) for a list of supported items.
...
[ALLOCATE DESCRIPTOR](#page-113-0), [SET DESCRIPTOR](#page-130-0)

## <span id="page-126-0"></span>**OPEN**
...
[DECLARE](#page-118-0), CLOSE

## <span id="page-127-0"></span>**PREPARE**
...
## <span id="page-129-0"></span>**SET CONNECTION**
...
[CONNECT](#page-114-0), [DISCONNECT](#page-121-0)

## <span id="page-130-0"></span>**SET DESCRIPTOR**
...
A token identifying which item of information to set in the descriptor. See [Section 36.7.1](#page-83-2) for a list of supported items.
...
See [Section 36.8.1](#page-96-0) for a description of the parameters.
...
# <span id="page-136-0"></span>**36.15. Informix Compatibility Mode**
