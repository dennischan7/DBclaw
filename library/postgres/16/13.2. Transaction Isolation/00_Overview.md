...
The result of successfully committing a group of transactions is inconsistent with all possible orderings of running those transactions one at a time.
 ...
 The SQL standard and PostgreSQL-implemented transaction isolation levels are described in [Ta](#page-124-0)[ble 13.1](#page-124-0).

<span id="page-124-0"></span>**Table 13.1. Transaction Isolation Levels**
