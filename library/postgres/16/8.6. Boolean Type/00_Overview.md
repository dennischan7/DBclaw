...
PostgreSQL provides the standard SQL type boolean; see [Table 8.19.](#page-3-1) The boolean type can have several states: "true", "false", and a third state, "unknown", which is represented by the SQL null value.

<span id="page-3-1"></span>**Table 8.19. Boolean Data Type**
...
<span id="page-4-0"></span>The datatype output function for type boolean always emits either t or f, as shown in [Example 8.2.](#page-4-0)
...
# <span id="page-4-1"></span>**8.7. Enumerated Types**
