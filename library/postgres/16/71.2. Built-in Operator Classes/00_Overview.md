...
The core PostgreSQL distribution includes the BRIN operator classes shown in [Table 71.1](#page-147-0).
...
<span id="page-147-0"></span>**Table 71.1. Built-in BRIN Operator Classes**
...
|                                                                                                                                            | <= (bigint,bigint)     |
| int8_minmax_multi_ops<br>interval_bloom_ops<br>interval_minmax_ops<br>interval_minmax_multi_ops<br>macaddr_bloom_ops<br>macaddr_minmax_ops | >= (bigint,bigint)     |
|                                                                                                                                            | = (bigint,bigint)      |
|                                                                                                                                            | < (bigint,bigint)      |
|                                                                                                                                            | > (bigint,bigint)      |
|                                                                                                                                            | <= (bigint,bigint)     |
