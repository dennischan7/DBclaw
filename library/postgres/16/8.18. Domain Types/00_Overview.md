...
# <span id="page-50-1"></span>**8.19. Object Identifier Types**

Object identifiers (OIDs) are used internally by PostgreSQL as primary keys for various system tables. Type oid represents an object identifier. There are also several alias types for oid, each named regsomething. [Table 8.26](#page-50-0) shows an overview.
...
<span id="page-50-0"></span>**Table 8.26. Object Identifier Types**

| Name | References | Description             | Value Example |
|------|------------|-------------------------|---------------|
| oid  | any        | numeric object identifi | 564182        |
|      |            | er                      |               |
...
The to\_regclass() function and its siblings can also be used to perform run-time lookups. See Table 9.72.
