...
## <span id="page-144-0"></span>**49.10. Two-phase Commit Support for Logical Decoding**
...
- The logical replication solution that builds distributed two phase commit using this feature can deadlock if the prepared transaction has locked [user] catalog tables exclusively. To avoid this users

#### Logical Decoding

| must refrain from having locks on catalog tables (e.g. explicit LOCK command) in such transactions.<br>See Section 49.8.2 for the details. |
|--------------------------------------------------------------------------------------------------------------------------------------------|
|                                                                                                                                            |
|                                                                                                                                            |
|                                                                                                                                            |
...
# <span id="page-146-0"></span>**Chapter 50. Replication Progress Tracking**

Replication origins are intended to make it easier to implement logical replication solutions on top of [logical decoding](#page-128-0). They provide a solution to two common problems:
