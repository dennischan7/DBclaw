...
# <span id="page-47-0"></span>**59.2. Foreign Data Wrapper Callback Routines**
...
See [Section 59.4](#page-64-0) for additional information.
...
Beginning with PostgreSQL 16, fs\_relids includes the rangetable indexes of outer joins, if any were involved in this join. The new field fs\_base\_relids includes only base relation indexes, and thus mimics fs\_relids's old semantics.
...
### <span id="page-51-0"></span>**59.2.4. FDW Routines for Updating Foreign Tables**
...
### <span id="page-58-0"></span>**59.2.6. FDW Routines for Row Locking**

If an FDW wishes to support *late row locking* (as described in [Section 59.5](#page-67-0)), it must provide the following callback functions:
...
See [Section 59.5](#page-67-0) for more information.
