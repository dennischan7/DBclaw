...
- Furthermore, the ordering is total; that is, for all non-null values A, B:
  - exactly one of A < B, A = B, and B < A is true (*trichotomy law*) (The trichotomy law justifies the definition of the comparison support function, of course.)
