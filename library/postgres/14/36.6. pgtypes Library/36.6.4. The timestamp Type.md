...
The function returns the parsed timestamp on success. On error, PGTYPESInvalidTimestamp is returned and errno is set to PGTYPES\_TS\_BAD\_TIMESTAMP. See [PGTYPESIn](#page-23-1)[validTimestamp](#page-23-1) for important notes on this value.
...
[Table 36.5](#page-17-0) contains a few examples for input strings.

<span id="page-17-0"></span>**Table 36.5. Valid Input Formats for PGTYPEStimestamp\_from\_asc**
...
This is the reverse function to [PGTYPEStimestamp\\_fmt\\_asc](#page-17-1). See the documentation there in order to find out about the possible formatting mask entries.
