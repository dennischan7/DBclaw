...
A standby server can be implemented using file-based log shipping [\(Section 27.2\)](#page-182-0) or streaming replication (see [Section 27.2.5](#page-185-0)), or a combination of both. For information on hot standby, see [Section 27.4](#page-192-0).
...
[Table 27.1](#page-181-0) summarizes the capabilities of the various solutions listed above.

<span id="page-181-0"></span>**Table 27.1. High Availability, Load Balancing, and Replication Feature Matrix**
...
# <span id="page-182-0"></span>**27.2. Log-Shipping Standby Servers**
