...
# <span id="page-54-0"></span>**30.1. Reliability**
...
- On Windows, if wal\_sync\_method is open\_datasync (the default), write caching can be disabled by unchecking My Computer\Open\disk drive\Properties\Hard-

<sup>1</sup> <http://sg.danny.cz/sg/sdparm.html>

ware\Properties\Policies\Enable write caching on the disk. Alternatively, set wal\_sync\_method to fsync or fsync\_writethrough, which prevent write caching.
