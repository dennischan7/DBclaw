...
The view column\_udt\_usage identifies all columns that use data types owned by a currently enabled role. Note that in PostgreSQL, built-in data types behave like user-defined types, so they are included here as well. See also [Section 37.17](#page-103-0) for details.
...
# <span id="page-103-0"></span>**37.17. columns**
