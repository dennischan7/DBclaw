...
# <span id="page-53-0"></span>**9.2. Comparison Functions and Operators**

The usual comparison operators are available, as shown in [Table 9.1.](#page-53-0)
...
There are also some comparison predicates, as shown in [Table 9.2](#page-53-1). These behave much like operators, but have special syntax mandated by the SQL standard.

<span id="page-53-1"></span>**Table 9.2. Comparison Predicates**
...
<span id="page-56-0"></span>Some comparison-related functions are also available, as shown in [Table 9.3.](#page-56-0)
