...
# <span id="page-102-0"></span>**53.7. Message Formats**
...
A code identifying the field type; if zero, this is the message terminator and no string follows. The presently defined field types are listed in [Section 53.8](#page-119-0). Since more field types might be added in future, frontends should silently ignore fields of unrecognized type.
...
NoticeResponse (B)
    ...
    Byte1
         ...
         The presently defined field types are listed in Section 53.8. Since more field types might be
...
Used to connect in streaming replication mode, where a small set of replication commands can be issued instead of SQL statements. Value can be true, false, or database, and the default is false. See [Section 53.4](#page-93-0) for details.
...
# <span id="page-119-0"></span>**53.8. Error and Notice Message Fields**
...
# <span id="page-120-0"></span>**53.9. Logical Replication Message Formats**

This section describes the detailed format of each logical replication message. These messages are returned either by the replication slot SQL interface or are sent by a walsender. In case of a walsender they are encapsulated inside the replication protocol WAL messages as described in [Section 53.4](#page-93-0) and generally obey same message flow as physical replication.
