...
title: 36.15.3. Informix-compatible SQLDA Descriptor Areas
---

Informix-compatible mode supports a different structure than the one described in [Section 36.7.2](#page-25-0). See below:
