...
SQL defines some string functions that use key words, rather than commas, to separate arguments. Details are in [Table 9.11](#page-74-0). PostgreSQL also provides versions of these functions that use the regular function invocation syntax (see [Table 9.12\)](#page-75-0).

<span id="page-74-0"></span>**Table 9.11. SQL Binary String Functions and Operators**
...
Additional binary string manipulation functions are available and are listed in [Table 9.12](#page-75-0). Some of them are used internally to implement the SQL-standard string functions listed in [Table 9.11.](#page-74-0)

#### <span id="page-75-0"></span>**Table 9.12. Other Binary String Functions**
...
Converts a binary string representing text in encoding src\_encoding to text in the database encoding (see Section 24.3.4 for available conversions).
...
Encodes binary data into a textual representation; supported format values are: [base64](#page-77-3), [escape](#page-77-4), [hex](#page-77-5).
...
See also the aggregate function string\_agg in [Section 9.21](#page-184-0) and the large object functions in Section 35.4.

# <span id="page-77-0"></span>**9.6. Bit String Functions and Operators**

This section describes functions and operators for examining and manipulating bit strings, that is values of the types bit and bit varying. (While only type bit is mentioned in these tables, values of type bit varying can be used interchangeably.) Bit strings support the usual comparison operators shown in [Table 9.1](#page-53-0), as well as the operators shown in [Table 9.14.](#page-78-0)

<sup>1</sup> <https://datatracker.ietf.org/doc/html/rfc2045#section-6.8>

#### <span id="page-78-0"></span>**Table 9.14. Bit String Operators**
...
Some of the functions available for binary strings are also available for bit strings, as shown in [Ta](#page-78-1)[ble 9.15](#page-78-1).

#### <span id="page-78-1"></span>**Table 9.15. Bit String Functions**
