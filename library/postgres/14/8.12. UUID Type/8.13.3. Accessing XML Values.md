...
# <span id="page-14-0"></span>**8.14. JSON Types**

JSON data types are for storing JSON (JavaScript Object Notation) data, as specified in [RFC 7159](https://datatracker.ietf.org/doc/html/rfc7159)<sup>4</sup> . Such data can also be stored as text, but the JSON data types have the advantage of enforcing that each stored value is valid according to the JSON rules. There are also assorted JSON-specific functions and operators available for data stored in these data types; see [Section 9.16.](#page-152-0)

PostgreSQL offers two types for storing JSON data: json and jsonb. To implement efficient query mechanisms for these data types, PostgreSQL also provides the jsonpath data type described in [Section 8.14.7.](#page-23-0)
...
<span id="page-16-0"></span>**Table 8.23. JSON Primitive Types and Corresponding PostgreSQL Types**
