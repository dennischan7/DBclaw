...
The monitoring information about subscription is visible in [pg\\_stat\\_subscription](#page-22-0). This view contains one row for every subscription worker. A subscription can have zero or more active subscription workers depending on its state.
