...
The other main category of maintenance task is periodic "vacuuming" of the database. This activity is discussed in [Section 25.1.](#page-151-0) Closely related to this is updating the statistics that will be used by the query planner, as discussed in [Section 25.1.3.](#page-153-0)

Another task that might need periodic attention is log file management. This is discussed in [Sec](#page-160-0)[tion 25.3.](#page-160-0)
