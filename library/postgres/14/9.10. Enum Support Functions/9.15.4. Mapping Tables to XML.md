...
# <span id="page-152-0"></span>**9.16. JSON Functions and Operators**
...
To learn more about the SQL/JSON standard, see [sqltr-19075-6]. For details on JSON types supported in PostgreSQL, see [Section 8.14](#page-14-0).