...
The view udt\_privileges identifies USAGE privileges granted on user-defined types to a currently enabled role or by a currently enabled role. There is one row for each combination of type, grantor, and grantee. This view shows only composite types (see under [Section 37.60](#page-138-0) for why); see [Section 37.59](#page-137-0) for domain privileges.
...
# <span id="page-137-0"></span>**37.59. usage\_privileges**
...
# <span id="page-138-0"></span>**37.60. user\_defined\_types**
