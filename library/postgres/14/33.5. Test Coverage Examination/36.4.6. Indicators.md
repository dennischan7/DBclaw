...
The indicator variable val\_ind will be zero if the value was not null, and it will be negative if the value was null. (See [Section 36.16](#page-91-0) to enable Oracle-specific behavior.)
