...
# <span id="page-164-0"></span>**57.4. Foreign Data Wrapper Query Planning**
...
# <span id="page-166-0"></span>**57.5. Row Locking in Foreign Data Wrappers**
...
By default, PostgreSQL ignores locking considerations when interfacing to FDWs, but an FDW can perform early locking without any explicit support from the core code. The API functions described in [Section 57.2.6,](#page-157-0) which were added in PostgreSQL 9.5, allow an FDW to use late locking if it wishes.
