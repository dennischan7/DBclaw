...
After restoring a backup, it is wise to run ANALYZE on each database so the query optimizer has useful statistics; see [Section 25.1.3](#page-153-0) and [Section 25.1.6](#page-158-0) for more information. For more advice on how to load large amounts of data into PostgreSQL efficiently, refer to Section 14.4.

# <span id="page-164-0"></span>**26.1.2. Using pg\_dumpall**
