...
# <span id="page-150-0"></span>**15.2. When Can Parallel Query Be Used?**
...
- The query uses any function marked PARALLEL UNSAFE. Most system-defined functions are PARALLEL SAFE, but user-defined functions are marked PARALLEL UNSAFE by default. See the discussion of [Section 15.4.](#page-153-0)
