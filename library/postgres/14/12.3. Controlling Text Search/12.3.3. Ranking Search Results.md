...
This function requires lexeme positional information to perform its calculation. Therefore, it ignores any "stripped" lexemes in the tsvector. If there are no unstripped lexemes in the input, the result will be zero. (See [Section 12.4.1](#page-82-0) for more information about the strip function and positional information in tsvectors.)
