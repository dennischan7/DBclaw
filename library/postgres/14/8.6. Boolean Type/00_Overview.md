...
PostgreSQL provides the standard SQL type boolean; see [Table 8.19.](#page-1-0) The boolean type can have several states: "true", "false", and a third state, "unknown", which is represented by the SQL null value.

<span id="page-1-0"></span>**Table 8.19. Boolean Data Type**
...
The datatype output function for type boolean always emits either t or f, as shown in [Example 8.2.](#page-1-1)

### <span id="page-1-1"></span>**Example 8.2. Using the boolean Type**
...
# <span id="page-2-0"></span>**8.7. Enumerated Types**
