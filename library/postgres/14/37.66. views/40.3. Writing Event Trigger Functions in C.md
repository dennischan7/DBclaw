...
Describes the event for which the function is called, one of "ddl\_command\_start", "ddl\_command\_end", "sql\_drop", "table\_rewrite". See [Section 40.1](#page-48-0) for the meaning of these events.
