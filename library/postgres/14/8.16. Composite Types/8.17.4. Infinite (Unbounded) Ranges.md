...
## <span id="page-42-0"></span>**8.17.5. Range Input/Output**
...
These rules are very similar to those for writing field values in composite-type literals. See [Section 8.16.6](#page-40-0) for additional commentary.
