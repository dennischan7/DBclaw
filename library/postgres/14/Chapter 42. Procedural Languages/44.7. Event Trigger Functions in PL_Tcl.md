...
title: 44.7. Event Trigger Functions in PL_Tcl
---
...
## <span id="page-161-0"></span>**44.8. Error Handling in PL/Tcl**
...
## <span id="page-162-0"></span>**44.9. Explicit Subtransactions in PL/Tcl**

Recovering from errors caused by database access as described in [Section 44.8](#page-161-0) can lead to an undesirable situation where some operations succeed before one of them fails, and after recovering from that error the data is left in an inconsistent state. PL/Tcl offers a solution to this problem in the form of explicit subtransactions.
