...
Another set of utility functions are plpy.quote\_literal(string), plpy.quote\_nullable(string), and plpy.quote\_ident(string). They are equivalent to the built-in quoting functions described in Section 9.4. They are useful when constructing ad-hoc queries. A PL/Python equivalent of dynamic SQL from [Example 43.1](#page-101-0) would be:
