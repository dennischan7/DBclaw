...
<span id="page-84-0"></span>[Example 42.1](#page-84-0) shows how the manual installation procedure would work with the language PL/Perl.
...
# <span id="page-86-0"></span>**Chapter 43. PL/pgSQL — SQL Procedural Language**