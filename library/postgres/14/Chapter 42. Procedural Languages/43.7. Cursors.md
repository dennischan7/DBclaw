...
Bound cursor variables can also be used without explicitly opening the cursor, via the FOR statement described in [Section 43.7.4](#page-124-0).
...
#### <span id="page-121-0"></span>**43.7.2.3. Opening a Bound Cursor**
...
### <span id="page-124-0"></span>**43.7.4. Looping through a Cursor's Result**
...
## <span id="page-125-0"></span>43.8. Transaction Management
