...
title: 67.5. GIN Tips and Tricks
---
...
When fastupdate is enabled for GIN (see [Section 67.4.1](#page-39-2) for details), the penalty is less than when it is not. But for very large updates it may still be best to drop and recreate the index.
