...
#### <span id="page-24-0"></span>**36.4.4.3.2. Structures**
...
You can declare pointers to the most common types. Note however that you cannot use pointers as target variables of queries without auto-allocation. See [Section 36.7](#page-47-0) for more information on auto-allocation.
