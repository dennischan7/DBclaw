...
The word The was recognized by the english\_ispell dictionary as a stop word ([Section 12.6.1\)](#page-96-0) and will not be indexed. The spaces are discarded too, since the configuration provides no dictionaries at all for them.
