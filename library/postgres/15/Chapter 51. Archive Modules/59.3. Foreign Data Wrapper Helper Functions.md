...
title: 59.3. Foreign Data Wrapper Helper Functions
---
...
## <span id="page-15-0"></span>**59.4. Foreign Data Wrapper Query Planning**
...
## <span id="page-17-0"></span>**59.5. Row Locking in Foreign Data Wrappers**
...
By default, PostgreSQL ignores locking considerations when interfacing to FDWs, but an FDW can perform early locking without any explicit support from the core code. The API functions described in [Section 59.2.6,](#page-8-0) which were added in PostgreSQL 9.5, allow an FDW to use late locking if it wishes.
