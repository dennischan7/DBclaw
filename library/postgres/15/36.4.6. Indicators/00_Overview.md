...
The indicator variable val\_ind will be zero if the value was not null, and it will be negative if the value was null. (See [Section 36.16](#page-115-0) to enable Oracle-specific behavior.)
...
# <span id="page-31-0"></span>**36.5. Dynamic SQL**
