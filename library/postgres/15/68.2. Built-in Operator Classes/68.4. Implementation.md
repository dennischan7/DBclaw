...
The sorted method is only available if each of the opclasses used by the index provides a sortsupport function, as described in [Section 68.3](#page-61-0). If they do, this method is usually the best, so it is used by default.
