...
The AT TIME ZONE operator converts time stamp *without* time zone to/from time stamp *with* time zone, and time with time zone values to different time zones. [Table 9.34](#page-122-0) shows its variants.

### <span id="page-122-0"></span>**Table 9.34. AT TIME ZONE Variants**
...
## <span id="page-123-0"></span>**9.9.5. Current Date/Time**
