...
# <span id="page-92-0"></span>**Chapter 49. Logical Decoding**
...
Changes can be consumed either using the streaming replication protocol (see Section 55.4 and [Sec](#page-97-0)[tion 49.3](#page-97-0)), or by calling functions via SQL (see [Section 49.4](#page-97-1)). It is also possible to write additional methods of consuming the output of a replication slot without modifying core code (see [Section 49.7](#page-106-0)).