...
A standby server can be implemented using file-based log shipping [\(Section 27.2\)](#page-189-0) or streaming replication (see [Section 27.2.5](#page-192-0)), or a combination of both. For information on hot standby, see [Section 27.4](#page-199-0).
...
[Table 27.1](#page-188-0) summarizes the capabilities of the various solutions listed above.

<span id="page-188-0"></span>**Table 27.1. High Availability, Load Balancing, and Replication Feature Matrix**
...
# <span id="page-189-0"></span>**27.2. Log-Shipping Standby Servers**
