...
# <span id="page-20-0"></span>**19.12. Registering Event Log on Windows**
...
To specify a different event source name (see [event\\_source](#page-69-0)), use the /n and /i options:
...
To enable event logging in the database server, modify [log\\_destination](#page-66-0) to include eventlog in postgresql.conf.

# <span id="page-22-0"></span>**Chapter 20. Server Configuration**
