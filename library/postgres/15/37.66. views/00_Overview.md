...
| 38.2.1. Base Types 1137                                          |      |
| 38.2.2. Container Types 1137                                     |      |
| 38.2.3. Domains 1138                                             |      |
| 38.2.4. Pseudo-Types 1138                                        |      |
| 38.2.5. Polymorphic Types                                        | 1138 |
| 38.3. User-Defined Functions 1140                                |      |
| 38.4. User-Defined Procedures                                    | 1141 |
| 38.5. Query Language (SQL) Functions 1141                        |      |
| 38.5.1. Arguments for SQL Functions 1142                         |      |
| 38.5.2. SQL Functions on Base Types                              | 1143 |
| 38.5.3. SQL Functions on Composite Types 1145                    |      |
| 38.5.4. SQL Functions with Output Parameters 1147                |      |
| 38.5.5. SQL Procedures with Output Parameters 1148               |      |
| 38.5.6. SQL Functions with Variable Numbers of Arguments 1149    |      |
| 38.5.7. SQL Functions with Default Values for Arguments 1150     |      |
| 38.5.8. SQL Functions as Table Sources 1151                      |      |
| 38.5.9. SQL Functions Returning Sets 1151                        |      |
|                                                                  |      |
| 38.5.10. SQL Functions Returning TABLE 1155                      |      |
| 38.5.11. Polymorphic SQL Functions 1155                          |      |
| 38.5.12. SQL Functions with Collations 1157                      |      |
...
| 38.10.1. Dynamic Loading 1161                                    |      |
| 38.10.2. Base Types in C-Language Functions 1162                 |      |
| 38.10.3. Version 1 Calling Conventions                           | 1165 |
| 38.10.4. Writing Code 1168                                       |      |
| 38.10.5. Compiling and Linking Dynamically-Loaded Functions 1169 |      |
| 38.10.6. Composite-Type Arguments 1171                           |      |
| 38.10.7. Returning Rows (Composite Types) 1172                   |      |
| 38.10.8. Returning Sets 1173                                     |      |
| 38.10.9. Polymorphic Arguments and Return Types                  | 1179 |
| 38.10.10. Shared Memory and LWLocks 1180                         |      |
| 38.10.11. Using C++ for Extensibility 1181                       |      |
| 38.11. Function Optimization Information                         | 1182 |
| 38.12. User-Defined Aggregates                                   | 1183 |
| 38.12.1. Moving-Aggregate Mode 1184                              |      |
| 38.12.2. Polymorphic and Variadic Aggregates 1186                |      |
| 38.12.3. Ordered-Set Aggregates 1187                             |      |
| 38.12.4. Partial Aggregation 1188                                |      |
| 38.12.5. Support Functions for Aggregates 1189                   |      |
| 38.13. User-Defined Types                                        | 1190 |
| 38.13.1. TOAST Considerations 1193                               |      |
| 38.14. User-Defined Operators                                    | 1194 |
| 38.15. Operator Optimization Information                         | 1195 |
| 38.15.1. COMMUTATOR 1195                                         |      |
| 38.15.2. NEGATOR 1196                                            |      |
| 38.15.3. RESTRICT 1196                                           |      |
| 38.15.4. JOIN 1197                                               |      |
| 38.15.5. HASHES 1197                                             |      |
|                                                                  |      |
...
| 38.16.1. Index Methods and Operator Classes             | 1199 |
| 38.16.2. Index Method Strategies 1199                   |      |
| 38.16.3. Index Method Support Routines 1201             |      |
| 38.16.4. An Example 1204                                |      |
| 38.16.5. Operator Classes and Operator Families         | 1206 |
| 38.16.6. System Dependencies on Operator Classes 1209   |      |
| 38.16.7. Ordering Operators 1210                        |      |
| 38.16.8. Special Features of Operator Classes 1211      |      |
| 38.17. Packaging Related Objects into an Extension 1212 |      |
| 38.17.1. Extension Files                                | 1213 |
| 38.17.2. Extension Relocatability 1215                  |      |
| 38.17.3. Extension Configuration Tables                 | 1216 |
| 38.17.4. Extension Updates 1217                         |      |
|                                                         |      |
| 38.17.5. Installing Extensions Using Update Scripts     | 1217 |
| 38.17.6. Security Considerations for Extensions 1218    |      |
| 38.17.7. Extension Example 1219                         |      |
...
| 41.2.1. How SELECT Rules Work 1245                      |      |
| 41.2.2. View Rules in Non-SELECT Statements 1249        |      |
| 41.2.3. The Power of Views in PostgreSQL 1250           |      |
| 41.2.4. Updating a View 1251                            |      |
| 41.3. Materialized Views 1251                           |      |
| 41.4. Rules on INSERT, UPDATE, and DELETE 1254          |      |
| 41.4.1. How Update Rules Work                           | 1255 |
| 41.4.2. Cooperation with Views 1259                     |      |
...
| 43.1. Overview 1273                                     |      |
| 43.1.1. Advantages of Using PL/pgSQL 1273               |      |
| 43.1.2. Supported Argument and Result Data Types 1273   |      |
| 43.2. Structure of PL/pgSQL 1274                        |      |
| 43.3. Declarations 1276                                 |      |
| 43.3.1. Declaring Function Parameters 1276              |      |
| 43.3.2. ALIAS 1280                                      |      |
| 43.3.3. Copying Types 1280                              |      |
| 43.3.4. Row Types                                       | 1280 |
| 43.3.5. Record Types 1281                               |      |
| 43.3.6. Collation of PL/pgSQL Variables 1281            |      |

| 43.4. Expressions                                    | 1282 |
|------------------------------------------------------|------|
| 43.5. Basic Statements                               | 1283 |
| 43.5.1. Assignment                                   | 1283 |
...
| 43.6.4. Conditionals                                 |      |
| 43.6.5. Simple Loops                                 | 1297 |
| 43.6.6. Looping through Query Results                | 1300 |
| 43.6.7. Looping through Arrays                       | 1301 |
...
| 43.10.1. Triggers on Data Changes                    | 1315 |
| 43.10.2. Triggers on Events                          | 1323 |
| 43.11. PL/pgSQL under the Hood                       | 1324 |
| 43.11.1. Variable Substitution                       | 1324 |
...
| 44.12. Tel Procedure Names                           |      |
| 45. PL/Perl — Perl Procedural Language               |      |
| · · · · · · · · · · · · · · · · · · ·                |      |
| 45.1. PL/Perl Functions and Arguments                |      |
| 45.2. Data Values in PL/Perl                         |      |
| 45.3. Built-in Functions                             |      |
| 45.3.1. Database Access from PL/Perl                 | 1357 |

| 45.3.2. Utility Functions in PL/Perl                       | 1361   |
|------------------------------------------------------------|--------|
...
| 46.2. Data Values                                          |        |
| 46.2.1. Data Type Mapping                                  | . 1369 |
| 46.2.2. Null, None                                         | . 1370 |
| 46.2.3. Arrays, Lists                                      | 1371   |
...
| 46.6.2. Trapping Errors                                    | 1379   |
| 46.7. Explicit Subtransactions                             | . 1380 |
| 46.7.1. Subtransaction Context Managers                    | 1380   |
...
| 51.2.1. Check Callback            | 1473 |
| 51.2.2. Archive Callback          | 1474 |
| 51.2.2 Shutdown Callbook          | 1/7/ |

# <span id="page-174-0"></span>**Chapter 38. Extending SQL**

In the sections that follow, we will discuss how you can extend the PostgreSQL SQL query language by adding:

- functions (starting in [Section 38.3\)](#page-177-0)
...
# <span id="page-174-1"></span>**38.1. How Extensibility Works**
...
# <span id="page-174-2"></span>**38.2. The PostgreSQL Type System**

PostgreSQL data types can be divided into base types, container types, domains, and pseudo-types.

# <span id="page-174-3"></span>**38.2.1. Base Types**
...
# <span id="page-174-4"></span>**38.2.2. Container Types**
...
# <span id="page-175-0"></span>**38.2.3. Domains**
...
# <span id="page-175-1"></span>**38.2.4. Pseudo-Types**
...
A variadic function (one taking a variable number of arguments, as in [Section 38.5.6](#page-186-0)) can be polymorphic: this is accomplished by declaring its last parameter as VARIADIC anyarray or VARIADIC anycompatiblearray. For purposes of argument matching and determining the actual result type, such a function behaves the same as if you had written the appropriate number of anynonarray or anycompatiblenonarray parameters.

# <span id="page-177-0"></span>**38.3. User-Defined Functions**

PostgreSQL provides four kinds of functions:

- query language functions (functions written in SQL) ([Section 38.5\)](#page-178-1)
- procedural language functions (functions written in, for example, PL/pgSQL or PL/Tcl) ([Sec](#page-197-0)[tion 38.8\)](#page-197-0)
- internal functions [\(Section 38.9](#page-197-1))
- C-language functions ([Section 38.10\)](#page-198-0)
...
# <span id="page-178-0"></span>**38.4. User-Defined Procedures**
...
# <span id="page-178-1"></span>**38.5. Query Language (SQL) Functions**
...
# <span id="page-179-0"></span>**38.5.1. Arguments for SQL Functions**
...
# <span id="page-180-0"></span>**38.5.2. SQL Functions on Base Types**
...
# <span id="page-182-0"></span>**38.5.3. SQL Functions on Composite Types**
...
The second way is described more fully in [Section 38.5.8.](#page-188-0)
...
# <span id="page-184-0"></span>**38.5.4. SQL Functions with Output Parameters**
...
This is not essentially different from the version of add\_em shown in [Section 38.5.2](#page-180-0). The real value of output parameters is that they provide a convenient way of defining functions that return several columns. For example,
...
# <span id="page-185-0"></span>**38.5.5. SQL Procedures with Output Parameters**
...
# <span id="page-186-0"></span>**38.5.6. SQL Functions with Variable Numbers of Arguments**
...
# <span id="page-187-0"></span>**38.5.7. SQL Functions with Default Values for Arguments**
...
# <span id="page-188-0"></span>**38.5.8. SQL Functions as Table Sources**
...
# <span id="page-188-1"></span>**38.5.9. SQL Functions Returning Sets**
...
# <span id="page-192-0"></span>**38.5.10. SQL Functions Returning TABLE**
...
# <span id="page-192-1"></span>**38.5.11. Polymorphic SQL Functions**

SQL functions can be declared to accept and return the polymorphic types described in [Section 38.2.5.](#page-175-2) Here is a polymorphic function make\_array that builds up an array from two arbitrary data type elements:
...
# <span id="page-194-0"></span>**38.5.12. SQL Functions with Collations**
...
# <span id="page-195-0"></span>**38.6. Function Overloading**
...
# <span id="page-196-0"></span>**38.7. Function Volatility Categories**
...
# <span id="page-197-0"></span>**38.8. Procedural Language Functions**
...
# <span id="page-197-1"></span>**38.9. Internal Functions**
...
# <span id="page-198-0"></span>**38.10. C-Language Functions**
...
# <span id="page-198-1"></span>**38.10.1. Dynamic Loading**
...
# <span id="page-199-0"></span>**38.10.2. Base Types in C-Language Functions**
...
*Never* modify the contents of a pass-by-reference input value. If you do so you are likely to corrupt on-disk data, since the pointer you are given might point directly into a disk buffer. The sole exception to this rule is explained in [Section 38.12](#page-20-0).
...
Finally, the version-1 function call conventions make it possible to return set results ([Section 38.10.8\)](#page-10-0) and implement trigger functions [\(Chapter 39](#page-62-0)) and procedural-language call handlers (Chapter 58). For more details see src/backend/utils/fmgr/README in the source distribution.
...
- Compiling and linking your code so that it can be dynamically loaded into PostgreSQL always requires special flags. See [Section 38.10.5](#page-6-0) for a detailed explanation of how to do it for your particular operating system.
...
## <span id="page-6-0"></span>**38.10.5. Compiling and Linking Dynamically-Loaded Functions**
...
### <span id="page-10-0"></span>**38.10.8. Returning Sets**
...
from your shmem\_request\_hook.
...
# <span id="page-19-0"></span>**38.11. Function Optimization Information**
...
# <span id="page-20-0"></span>**38.12. User-Defined Aggregates**
...
# <span id="page-27-0"></span>**38.13. User-Defined Types**
...
### <span id="page-30-0"></span>**38.13.1. TOAST Considerations**
...
# <span id="page-31-0"></span>**38.14. User-Defined Operators**
...
Here is an example of creating an operator for adding two complex numbers. We assume we've already created the definition of type complex (see [Section 38.13\)](#page-27-0). First we need a function that does the work, then we can define the operator:
