...
## <span id="page-5-0"></span>**46.1. PL/Python Functions**
...
## <span id="page-6-0"></span>**46.2. Data Values**
...
If an SQL null value is passed to a function, the argument value will appear as None in Python. For example, the function definition of pymax shown in [Section 46.1](#page-5-0) will return the wrong answer for null inputs. We could add STRICT to the function definition to make PostgreSQL do something more reasonable: if a null value is passed, the function will not be called at all, but will just return a null result automatically. Alternatively, we could check for null inputs in the function body:
...
## <span id="page-12-0"></span>**46.3. Sharing Data**
