...
INFO: EXECQ: 1 -- returned by execq and inserted by upper
 INSERT
 execq
-------
 2
...
-- execq is called twice and sees different numbers of rows each
 time:
...
---
 ...
 6 -- 3 rows (2 + 1 just inserted) * 2 (x in
 second row)
(4 rows)
```