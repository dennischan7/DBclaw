...
Query parameters and result row fields are converted between PostgreSQL and Python data types as described in [Section 46.2.](#page-6-0)

When you prepare a plan using the PL/Python module it is automatically saved. Read the SPI documentation [\(Chapter 47\)](#page-21-0) for a description of what this means. In order to make effective use of this across function calls one needs to use one of the persistent storage dictionaries SD or GD (see [Section 46.3\)](#page-12-0). For example:
...
### <span id="page-16-0"></span>**46.6.2. Trapping Errors**
