...
or otherwise a note about which tests failed. See [Section 33.2](#page-99-0) below before assuming that a "failure" represents a serious problem.
...
make MAX\_CONNECTIONS=10 check
