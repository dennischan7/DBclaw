...
is\_derived\_reference\_attribute yes\_or\_no Applies to a feature not available in PostgreSQL

See also under [Section 37.17,](#page-127-0) a similarly structured view, for further information on some of the columns.

# <span id="page-122-0"></span>**37.7. character\_sets**
