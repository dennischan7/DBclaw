...
The built-in parser is named pg\_catalog.default. It recognizes 23 token types, shown in [Ta](#page-93-0)[ble 12.1](#page-93-0).

<span id="page-93-0"></span>**Table 12.1. Default Parser's Token Types**
...
# <span id="page-95-0"></span>**12.6. Dictionaries**
...
## <span id="page-96-0"></span>**12.6.1. Stop Words**
