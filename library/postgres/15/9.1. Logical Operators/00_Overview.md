...
# <span id="page-55-0"></span>**9.2. Comparison Functions and Operators**

The usual comparison operators are available, as shown in [Table 9.1.](#page-55-0)
...
There are also some comparison predicates, as shown in [Table 9.2](#page-55-1). These behave much like operators, but have special syntax mandated by the SQL standard.

<span id="page-55-1"></span>**Table 9.2. Comparison Predicates**
...
<span id="page-58-0"></span>Some comparison-related functions are also available, as shown in [Table 9.3.](#page-58-0)
