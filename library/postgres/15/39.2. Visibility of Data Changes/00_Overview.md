...
Further information about data visibility rules can be found in Section 47.5. The example in [Sec](#page-68-0)[tion 39.4](#page-68-0) contains a demonstration of these rules.