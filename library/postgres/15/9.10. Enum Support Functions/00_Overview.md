...
For enum types (described in [Section 8.7](#page-3-1)), there are several functions that allow cleaner programming without hard-coding particular values of an enum type. These are listed in [Table 9.35](#page-125-0). The examples assume an enum type created as:
...
### <span id="page-125-0"></span>**Table 9.35. Enum Support Functions**
...
# <span id="page-126-0"></span>**9.11. Geometric Functions and Operators**

The geometric types point, box, lseg, line, path, polygon, and circle have a large set of native support functions and operators, shown in [Table 9.36,](#page-126-1) [Table 9.37,](#page-129-0) and [Table 9.38](#page-130-0).

### <span id="page-126-1"></span>**Table 9.36. Geometric Operators**
...
### **Operator Description Example(s)** point ?| point → boolean Are points vertically aligned (that is, have same x coordinate)? point '(0,1)' ?| point '(0,0)' → t line ?-| line → boolean lseg ?-| lseg → boolean Are lines perpendicular? lseg '[(0,0),(0,1)]' ?-| lseg '[(0,0),(1,0)]' → t
...
#### <span id="page-129-0"></span>**Table 9.37. Geometric Functions**
...
#### <span id="page-130-0"></span>**Table 9.38. Geometric Type Conversion Functions**
...
# <span id="page-133-0"></span>**9.12. Network Address Functions and Operators**

The IP network address types, cidr and inet, support the usual comparison operators shown in [Table 9.1](#page-55-0) as well as the specialized operators and functions shown in [Table 9.39](#page-133-1) and [Table 9.40.](#page-134-0)
...
### <span id="page-133-1"></span>**Table 9.39. IP Address Operators**
...
#### <span id="page-134-0"></span>**Table 9.40. IP Address Functions**
...
The MAC address types, macaddr and macaddr8, support the usual comparison operators shown in [Table 9.1](#page-55-0) as well as the specialized functions shown in [Table 9.41](#page-135-0). In addition, they support the bitwise logical operators ~, & and | (NOT, AND and OR), just as shown above for IP addresses.

#### <span id="page-135-0"></span>**Table 9.41. MAC Address Functions**
...
# <span id="page-136-0"></span>**9.13. Text Search Functions and Operators**

[Table 9.42](#page-136-1), [Table 9.43](#page-137-0) and [Table 9.44](#page-141-0) summarize the functions and operators that are provided for full text searching. See Chapter 12 for a detailed explanation of PostgreSQL's text search facility.

### <span id="page-136-1"></span>**Table 9.42. Text Search Operators**
...
In addition to these specialized operators, the usual comparison operators shown in [Table 9.1](#page-55-0) are available for types tsvector and tsquery. These are not very useful for text searching but allow, for example, unique indexes to be built on columns of these types.

#### <span id="page-137-0"></span>**Table 9.43. Text Search Functions**
...
The functions in [Table 9.44](#page-141-0) are listed separately because they are not usually used in everyday text searching operations. They are primarily helpful for development and debugging of new text search configurations.

#### <span id="page-141-0"></span>**Table 9.44. Text Search Debugging Functions**
...
# <span id="page-142-0"></span>**9.14. UUID Functions**
...
PostgreSQL also provides the usual comparison operators shown in [Table 9.1](#page-55-0) for UUIDs.

# <span id="page-142-1"></span>**9.15. XML Functions**

The functions and function-like expressions described in this section operate on values of type xml. See [Section 8.13](#page-14-0) for information about the xml type. The function-like expressions xmlparse and xmlserialize for converting to and from type xml are documented there, not in this section.
