...
The functions shown in [Table 9.102](#page-43-0) provide information about a table for which a table\_rewrite event has just been called. If called in any other context, an error is raised.

<span id="page-43-0"></span>**Table 9.102. Table Rewrite Information Functions**
