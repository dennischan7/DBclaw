...
For permission checking, the set of "applicable roles" is applied, which can be broader than the set of enabled roles. So generally, it is better to use the view applicable\_roles instead of this one; See [Section 37.5](#page-119-0) for details on applicable\_roles view.
